...
WHERE invh.date_actual>=\'' . $fromDate . '\' AND invh.date_actual<=\'' . $toDate . '\' AND invh.cd=\'' . $range . '\' AND tbl_mst_item_category.id=' . $category . ' AND invh.b_a=\'A\' AND invh.tot_a_val<>0 ' . $str . ' GROUP BY invh.ag_cd,shop_mst.sh_ro_cd,shop_mst.sh_cd,invh.cd, item_mst.cat
HAVING 
' . $havings . ' 
