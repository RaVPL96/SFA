...
class LogisticsModule extends CI_Model {
    ...
    function getServicedetails($id = null) {
        ...
        $this->db->select('`pri_tbl_trans_service`.`id`, `pri_tbl_mst_vehicle`.`vehicle_no`, `pri_tbl_mst_driver`.`nic`, `pri_tbl_mst_department`.`name`,`pri_tbl_mst_driver`.`full_name`, `from_location`, `to_location`, `request_date`, `system_mileage`, `start_mileage`, `end_mileage`, `manual_mileage`, `additional_diesel`, `total_cost`,');
