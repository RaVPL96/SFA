...
class LogisticsModule extends CI_Model {
    ...
    function getRate($id = null,$vehicleid=null) {
     ...
     function getDriverBookingDetails($id = null) {
        ...
        $this->db->select('`pri_tbl_mst_driver_booking`.`id`,`pri_tbl_mst_company`.`name` as company_name,pri_tbl_mst_driver_booking.reason,`pri_tbl_mst_driver_booking`.`requester_name`,`pri_tbl_mst_driver_booking`.`from_time`,`pri_tbl_mst_driver_booking`.`to_time`, `pri_tbl_mst_driver`.`nic`,`pri_tbl_mst_driver`.`name` as driver_name,`pri_tbl_mst_department`.`id` as `department_id`,`pri_tbl_mst_department`.`name`,`pri_tbl_mst_driver`.`full_name`,`pri_tbl_mst_driver`.`driver_number`, `from_location`, `to_location`, `request_date`,`to_date`,`pri_tbl_mst_driver_booking`.`requester_name`, `total_cost`,`pri_tbl_mst_driver_booking`.`reason`,pri_tbl_mst_driver_booking.status');
        ...
        $this->db->join('`pri_tbl_mst_department`', '`pri_tbl_mst_driver_booking`.`department__id`=`pri_tbl_mst_department`.`id`', 'INNER');
