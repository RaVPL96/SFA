...
INNER JOIN area_d ON agency_mst.ag_cd=area_d.ag_cd
INNER JOIN area_h ON area_d.area_cd=area_h.area_cd          
WHERE ' . $str . ' AND invh.b_a=\'A\' AND invh.tot_a_val!=0 AND shop_mst.sh_stat=0) inv_shop ON shop_mst.Auto=inv_shop.Auto 
WHERE  inv_shop.Auto IS NULL AND shop_mst.sh_stat=0 AND area_h.area_cd=' . $area . ';');
