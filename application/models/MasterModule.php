...
class MasterModule extends CI_Model {
    ...
    function saveGeography($data) {
        ...
        $distributor_userid = $data['distributor_username'];
        $id = $data['id'];
        ...
        $arr = array(
            ...
            '`agent_username`' => $distributor_userid
        );
        $this->db->trans_begin();
        if ($id == 'new') {
