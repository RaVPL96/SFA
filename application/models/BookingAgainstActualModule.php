...
class BookingAgainstActualModule extends CI_Model {
    ...
    function getItemSalesDetails($areaID = null, $territoryID = null, $routeID = null, $rangeID = null, $billingType = null, $dateFrom = null, $dateTo = null, $recordType = 'summery', $channel_id = 1,$reportType=null){
        
//        $this->db->select('`tbl_mst_item_category.id` AS `categoryItd`,`tbl_mst_item_category.name` AS `categoryName`,`tbl_mst_territory.id` AS `territoryId`,`tbl_mst_territory.territory_name` AS `territoryName`,`tbl_mst_area.area_name` AS `areaName`,`invd.a_Qty` AS `aQty`,`invd.b_qty` AS `bQty`,`invd.c_qty` AS `cQty`,`invd.m_qty` AS `mQty`,`invd.g_qty` AS `g_qty`,`invd.f_qty` AS `f_qty`');
        
       
        
        
        if ($reportType == 'cw') {
                $this->db->select('`tbl_mst_item_category.id` AS `categoryItd`,`tbl_mst_item_category.name` AS `categoryName`,SUM(`invd`.`a_Qty`) AS `aQty`,SUM(`invd`.`b_Qty`) AS `bQty`,SUM(`invd`.`c_Qty`) AS `cQty`,SUM(`invd`.`m_Qty`) AS `mQty`,SUM(`invd`.`g_Qty`) AS `g_qty`,SUM(`invd`.`f_Qty`) AS `f_qty`');
                $this->db->group_by('`tbl_mst_item_category`.`id`');
                $this->db->order_by('`tbl_mst_item_category`.`id`');
            } else if($reportType == 'iw'){
                $this->db->select('`item_mst.des` AS `itemDes`,`item_mst.item` AS `itemCode`,SUM(`invd`.`a_Qty`) AS `aQty`,SUM(`invd`.`b_Qty`) AS `bQty`,SUM(`invd`.`c_Qty`) AS `cQty`,SUM(`invd`.`m_Qty`) AS `mQty`,SUM(`invd`.`g_Qty`) AS `g_qty`,SUM(`invd`.`f_Qty`) AS `f_qty`');
                $this->db->group_by('`item_mst`.`item`'); 
                $this->db->order_by('`item_mst`.`item`');
            }else if($reportType == 'iaw'){
                $this->db->select('`tbl_mst_area.area_name` AS `areaName`,`item_mst.des` AS `itemDes`,`item_mst.item` AS `itemCode`,SUM(`invd`.`a_Qty`) AS `aQty`,SUM(`invd`.`b_Qty`) AS `bQty`,SUM(`invd`.`c_Qty`) AS `cQty`,SUM(`invd`.`m_Qty`) AS `mQty`,SUM(`invd`.`g_Qty`) AS `g_qty`,SUM(`invd`.`f_Qty`) AS `f_qty`');
                $this->db->group_by('`item_mst`.`item`,`tbl_mst_area`.`id`'); 
                $this->db->order_by('`item_mst`.`item`,`tbl_mst_area`.`id`');
            }else if($reportType == 'caw'){
                $this->db->select('`tbl_mst_item_category.id` AS `categoryItd`,`tbl_mst_item_category.name` AS `categoryName`,`tbl_mst_area.area_name` AS `areaName`,SUM(`invd`.`a_Qty`) AS `aQty`,SUM(`invd`.`b_Qty`) AS `bQty`,SUM(`invd`.`c_Qty`) AS `cQty`,SUM(`invd`.`m_Qty`) AS `mQty`,SUM(`invd`.`g_Qty`) AS `g_qty`,SUM(`invd`.`f_Qty`) AS `f_qty`');
                $this->db->group_by('`tbl_mst_item_category`.`id`,`tbl_mst_area`.`id`');
                $this->db->order_by('`tbl_mst_item_category`.`id`,`tbl_mst_area`.`id`');
            }else if($reportType == 'ctw'){
                $this->db->select('`tbl_mst_territory.id` AS `territoryId`,`tbl_mst_territory.territory_name` AS `territoryName`,`tbl_mst_item_category.id` AS `categoryItd`,`tbl_mst_item_category.name` AS `categoryName`,SUM(`invd`.`a_Qty`) AS `aQty`,SUM(`invd`.`b_Qty`) AS `bQty`,SUM(`invd`.`c_Qty`) AS `cQty`,SUM(`invd`.`m_Qty`) AS `mQty`,SUM(`invd`.`g_Qty`) AS `g_qty`,SUM(`invd`.`f_Qty`) AS `f_qty`');
                $this->db->group_by('`tbl_mst_item_category`.`id`,`tbl_mst_territory`.`reference_code`');
                $this->db->order_by('`tbl_mst_item_category`.`id`,`tbl_mst_territory`.`reference_code`');
            }else if($reportType == 'itw'){
                $this->db->select('`tbl_mst_territory.id` AS `territoryId`,`tbl_mst_territory.territory_name` AS `territoryName`,`item_mst.des` AS `itemDes`,`item_mst.item` AS `itemCode`,SUM(`invd`.`a_Qty`) AS `aQty`,SUM(`invd`.`b_Qty`) AS `bQty`,SUM(`invd`.`c_Qty`) AS `cQty`,SUM(`invd`.`m_Qty`) AS `mQty`,SUM(`invd`.`g_Qty`) AS `g_qty`,SUM(`invd`.`f_Qty`) AS `f_qty`');
                $this->db->group_by('`item_mst`.`item`,`tbl_mst_territory`.`reference_code`');
                $this->db->order_by('`item_mst`.`item`,`tbl_mst_territory`.`reference_code`');
            }else if($reportType == '00'){
                        $this->db->select('`tbl_mst_item_category.id` AS `categoryItd`,`tbl_mst_item_category.name` AS `categoryName`,`tbl_mst_territory.id` AS `territoryId`,`tbl_mst_territory.territory_name` AS `territoryName`,`tbl_mst_area.area_name` AS `areaName`,SUM(`invd`.`a_Qty`) AS `aQty`,SUM(`invd`.`b_Qty`) AS `bQty`,SUM(`invd`.`c_Qty`) AS `cQty`,SUM(`invd`.`m_Qty`) AS `mQty`,SUM(`invd`.`g_Qty`) AS `g_qty`,SUM(`invd`.`f_Qty`) AS `f_qty`');
        ...
        $this->db->join('`item_mst`', '`item_mst`.`item`=`invd`.`item`', 'INNER');
        $this->db->join('`tbl_mst_range_item`', '`tbl_mst_range_item`.`item`=`item_mst`.`item`', 'INNER');
        $this->db->join('`tbl_mst_item_category_link_item`', '`tbl_mst_item_category_link_item`.`item_id`=`item_mst`.`item`', 'INNER');
        $this->db->join('`tbl_mst_territory`', '`tbl_mst_territory`.`reference_code`=`invh`.`ag_cd`', 'INNER');
        $this->db->join('`tbl_mst_geography`', '`tbl_mst_geography`.`territory_id`=`tbl_mst_territory`.`id`', 'INNER');
        $this->db->join('`tbl_mst_item_category`', '`tbl_mst_item_category`.`id`=`tbl_mst_item_category_link_item`.`category_id`', 'INNER');
        $this->db->join('`tbl_mst_area`', '`tbl_mst_area`.`id`=`tbl_mst_geography`.`area_id`', 'INNER');
...
//        echo $this->db->last_query().'<br>';
    ...
    function getDiscountDetail($areaID = null, $territoryID = null, $routeID = null, $rangeID = null, $dateFrom = null, $dateTo = null){
        
        $this->db->select('`invh`.`invno`,`invh`.`ro_cd`,`invh`.`sh_cd`,`shop_mst`.`sh_name`,`invh`.`tot_a_val`,`invh`.`dis_per`,`invh`.`tot_dis`,`invh`.`date_book`,`invh`.`date_actual`');
        $this->db->from('`invh`');
        ...
        if(!empty($dateFrom) && isset($dateFrom) && !empty($dateTo) && isset($dateTo)){
        $this->db->where('`invh`.`date_actual` BETWEEN \'' . $dateFrom . '\' AND \'' . $dateTo.'\'');      
        }
        
        if(!empty($agency) && isset($agency)){    
        $this->db->where('`invh`.`ag_cd`',$agency);
        }
...
//$this->db->select('`d`.`agency_name`, `d`.`agency_code`, `w`.`distributor_id`, `w`.id AS `location_code`, `tbl_trans_distributor_warehouse_stock`.`item`, `tbl_mst_item`.`description`, `tbl_mst_item`.`uom`, SUM(`op_sellable`) AS op_sellable, SUM(`op_damage`) AS op_damage, SUM(`invoice_a_qty`) AS invoice_a_qty, SUM(`invoice_f_qty`) AS invoice_f_qty, SUM(`invoice_g_qty`) AS invoice_g_qty, SUM(`invoice_g_free_qty`) AS invoice_g_free_qty, SUM(`invoice_m_qty`) AS invoice_m_qty, SUM(`invoice_m_free_qty`) AS invoice_m_free_qty, SUM(`good_return_qty`) AS good_return_qty, SUM(`market_return_qty`) AS market_return_qty, SUM(`head_office_inv_qty`) AS head_office_inv_qty, SUM(`head_office_inv_qty_pending_accept`) AS head_office_inv_qty_pending_accept');
        ...
        if(!empty($areaID) && isset($areaID) && $areaID != null && $areaID != -1){
            $this->db->select('  `tbl_mst_item`.`item`, `tbl_mst_item`.`description`, `tbl_mst_item`.`uom`, SUM(`op_sellable`) AS op_sellable, SUM(`op_damage`) AS op_damage, SUM(`invoice_a_qty`) AS invoice_a_qty, SUM(`invoice_f_qty`) AS invoice_f_qty, SUM(`invoice_g_qty`) AS invoice_g_qty, SUM(`invoice_g_free_qty`) AS invoice_g_free_qty, SUM(`invoice_m_qty`) AS invoice_m_qty, SUM(`invoice_m_free_qty`) AS invoice_m_free_qty, SUM(`good_return_qty`) AS good_return_qty, SUM(`market_return_qty`) AS market_return_qty, SUM(`head_office_inv_qty`) AS head_office_inv_qty, SUM(`head_office_inv_qty_pending_accept`) AS head_office_inv_qty_pending_accept,SUM(`op_sellable`*`unit_price`) AS op_sellable_up, SUM(`op_damage`*`unit_price`) AS op_damage_up, SUM(`invoice_a_qty`*`unit_price`) AS invoice_a_qty_up, SUM(`invoice_f_qty`*0) AS invoice_f_qty_up, SUM(`invoice_g_qty`*`unit_price`) AS invoice_g_qty_up, SUM(`invoice_g_free_qty`*0) AS invoice_g_free_qty_up, SUM(`invoice_m_qty`*`unit_price`) AS invoice_m_qty_up, SUM(`invoice_m_free_qty`*0) AS invoice_m_free_qty_up, SUM(`good_return_qty`*`unit_price`) AS good_return_qty_up, SUM(`market_return_qty`*`unit_price`) AS market_return_qty_up, SUM(`head_office_inv_qty`*`unit_price`) AS head_office_inv_qty_up, SUM(`head_office_inv_qty_pending_accept`*`unit_price`) AS head_office_inv_qty_pending_accept_up,SUM(avg_sale) AS avg_sale');
        }else{
            $this->db->select('`d`.`agency_name`, `d`.`agency_code`, `w`.`distributor_id`, `w`.id AS `location_code`, `tbl_mst_item`.`item`, `tbl_mst_item`.`description`, `tbl_mst_item`.`uom`, SUM(`op_sellable`) AS op_sellable, SUM(`op_damage`) AS op_damage, SUM(`invoice_a_qty`) AS invoice_a_qty, SUM(`invoice_f_qty`) AS invoice_f_qty, SUM(`invoice_g_qty`) AS invoice_g_qty, SUM(`invoice_g_free_qty`) AS invoice_g_free_qty, SUM(`invoice_m_qty`) AS invoice_m_qty, SUM(`invoice_m_free_qty`) AS invoice_m_free_qty, SUM(`good_return_qty`) AS good_return_qty, SUM(`market_return_qty`) AS market_return_qty, SUM(`head_office_inv_qty`) AS head_office_inv_qty, SUM(`head_office_inv_qty_pending_accept`) AS head_office_inv_qty_pending_accept,SUM(`op_sellable`*`unit_price`) AS op_sellable_up, SUM(`op_damage`*`unit_price`) AS op_damage_up, SUM(`invoice_a_qty`*`unit_price`) AS invoice_a_qty_up, SUM(`invoice_f_qty`*0) AS invoice_f_qty_up, SUM(`invoice_g_qty`*`unit_price`) AS invoice_g_qty_up, SUM(`invoice_g_free_qty`*0) AS invoice_g_free_qty_up, SUM(`invoice_m_qty`*`unit_price`) AS invoice_m_qty_up, SUM(`invoice_m_free_qty`*0) AS invoice_m_free_qty_up, SUM(`good_return_qty`*`unit_price`) AS good_return_qty_up, SUM(`market_return_qty`*`unit_price`) AS market_return_qty_up, SUM(`head_office_inv_qty`*`unit_price`) AS head_office_inv_qty_up, SUM(`head_office_inv_qty_pending_accept`*`unit_price`) AS head_office_inv_qty_pending_accept_up,sum(avg_sale) AS avg_sale');
        }
        //$this->db->from('tbl_trans_distributor_warehouse_stock');
        //$this->db->join('`tbl_mst_item`', 'tbl_trans_distributor_warehouse_stock.item=tbl_mst_item.item', 'INNER');
        //$this->db->join('`tbl_mst_range_item`', 'tbl_mst_item.item=tbl_mst_range_item.item', 'RIGHT');
        $this->db->from('tbl_mst_range_item');
        $this->db->join('`tbl_mst_item`', 'tbl_mst_range_item.item=tbl_mst_item.item', 'INNER');
        $this->db->join('`tbl_trans_distributor_warehouse_stock`', 'tbl_mst_item.item=tbl_trans_distributor_warehouse_stock.item', 'INNER');
        ...
        $this->db->not_like('`tbl_mst_item`.`item`', 'PR');  
        
        if (!empty($rangeID) && isset($rangeID) && $rangeID != null && $rangeID != 'null') {
            $this->db->where('`tbl_mst_range_item`.`range_name`', $rangeID);
            $this->db->where('`tbl_mst_range`.`range_name`', $rangeID);
        }
        if(!empty($areaID) && isset($areaID) && $areaID != null && $areaID != -1){
            $this->db->where('`tbl_mst_area`.`id`', $areaID);            
        }
        ...
        $this->db->order_by('`d`.`agency_name`, `d`.`agency_code`, `tbl_mst_range_item`.`category_sequence`, `tbl_mst_range_item`.`item_sequence`,`tbl_mst_range_item`.`item`');
        $queryData = $this->db->get();
        $resultData = $queryData->result_array();
        // echo $this->db->last_query();
        return $resultData;
    ...
    function getStockDataCommonCategory($areaID = null, $warehouseCommonId = null, $rangeID = null, $FromDate = null, $ToDate = null, $rpt_type = 'summery', $category = null) {
        ...
        //    $this->db->where('`tbl_mst_area`.`id`', $areaID);
        //}
        //kasdjkk akdjasjkj sjsjdjskjd skj
        //AREA FILTER IF STOCK WRONG REMOVE THIS
        $this->db->join('tbl_mst_distributor_warehouse w', 'tbl_mst_distributor_warehouse_common.common_warehouse_id=w.id', 'INNER');
        $this->db->join('`tbl_mst_distributor` d', 'w.distributor_id=d.id', 'INNER');

        //2024-07-17 Commented $this->db->join('`tbl_mst_territory`', '`d`.`agency_code`=`tbl_mst_territory`.`reference_code`', 'INNER');
        $this->db->join('`tbl_mst_territory`', '`tbl_mst_distributor`.`agency_code`=`tbl_mst_territory`.`reference_code`', 'INNER');
...
WHERE  inv_shop.Auto IS NULL AND shop_mst.sh_stat=0;');
    ...
    /////////////////////////////////////
    //get Daily sales
    function getDailySalesNewDemarcation($area = null, $range = null, $datepickermonth = null,$bookingAct = 'A') {
        $str = '';
        if (!empty($area) && isset($area) && $area != null && $area != -1) {
...
ORDER BY tbl_mst_region.id,tbl_mst_area.display_order,tbl_mst_area.area_name,agency_mst.ag_name,invh.ag_cd,cd');
        $result = $q->result_array();
        //echo $this->db->last_query();
        ...
        $year = date('Y', strtotime($datepickermonth));
        for ($n = 1; $n <= date('t', strtotime($datepickermonth)); $n++) {
            //$strQ .= 'SUM(IF(month(invh.date_book)=' . $monthNumber . ' AND year(invh.date_book)=' . $year . ' AND day(invh.date_book)=' . $n . ', (invh.tot_a_val+invh.tot_dis),0)) AS `' . $monthName . '-' . $n . '`,';
            //S RANGE SUPPORT
            if ($range == 'D') {
                $strQ .= 'SUM(CASE WHEN (tbl_mst_geography.range_id!=3 AND month(invh.date_book)=' . $monthNumber . ' AND year(invh.date_book)=' . $year . ' AND day(invh.date_book)=' . $n . ') THEN ((invh.tot_a_val+invh.tot_dis)) WHEN (tbl_mst_geography.range_id=3 AND month(invh.date_book)=' . $monthNumber . ' AND year(invh.date_book)=' . $year . ' AND day(invh.date_book)=' . $n . ') THEN ( (invh.tot_a_val*`invh_cd_ratio`.`d_ratio`+invh.tot_dis*`invh_cd_ratio`.`d_ratio` )) END) AS `' . $monthName . '-' . $n . '`,';
            } else {
                $strQ .= 'SUM(CASE WHEN (tbl_mst_geography.range_id!=3) THEN (IF(month(invh.date_book)=' . $monthNumber . ' AND year(invh.date_book)=' . $year . ' AND day(invh.date_book)=' . $n . ', (invh.tot_a_val+invh.tot_dis),0)) WHEN (tbl_mst_geography.range_id=3) THEN (IF(month(invh.date_book)=' . $monthNumber . ' AND year(invh.date_book)=' . $year . ' AND day(invh.date_book)=' . $n . ', (invh.tot_a_val*`invh_cd_ratio`.`c_ratio`+invh.tot_dis*`invh_cd_ratio`.`c_ratio`),0)) END) AS `' . $monthName . '-' . $n . '`,';
            }
            $strQ .= 'COUNT(DISTINCT CASE WHEN (month(invh.date_book)=' . $monthNumber . ' AND year(invh.date_book)=' . $year . ' AND day(invh.date_book)=' . $n . ') THEN shop_mst.Auto END) AS `' . $monthName . '-' . $n . '-pc`,';
        }
        $strBack = '';
        for ($k = 1; $k <= 6; $k++) {
            $monthNumberBack = date('m', strtotime($datepickermonth . ' -' . $k . ' month'));
            ...
            $yearBack = date('Y', strtotime($datepickermonth . ' -' . $k . ' month'));
            if ($range == 'D') {
                $strBack .= ' SUM(CASE WHEN (tbl_mst_geography.range_id!=3) THEN IF(month(invh.date_book)=' . $monthNumberBack . ' AND year(invh.date_book)=' . $yearBack . ', invh.tot_a_val+invh.tot_dis,0) ELSE IF(month(invh.date_book)=' . $monthNumberBack . ' AND year(invh.date_book)=' . $yearBack . ', invh.tot_a_val*`invh_cd_ratio`.`d_ratio`+invh.tot_dis*`invh_cd_ratio`.`d_ratio`,0) END) AS `' . $monthNameBack . '-Total`, ';
            } else {
                $strBack .= ' SUM(CASE WHEN (tbl_mst_geography.range_id!=3) THEN IF(month(invh.date_book)=' . $monthNumberBack . ' AND year(invh.date_book)=' . $yearBack . ', invh.tot_a_val+invh.tot_dis,0) ELSE IF(month(invh.date_book)=' . $monthNumberBack . ' AND year(invh.date_book)=' . $yearBack . ', invh.tot_a_val*`invh_cd_ratio`.`c_ratio`+invh.tot_dis*`invh_cd_ratio`.`c_ratio`,0) END) AS `' . $monthNameBack . '-Total`, ';
            }
        }
        $strp1 = '';
        if ($range == 'D') {
        ...
        $str2 = '';
        if ($range == 'D') {
            $str2 = 'SUM(CASE WHEN (tbl_mst_geography.range_id!=3) THEN IF(month(invh.date_book)=' . $monthNumber . ' AND year(invh.date_book)=' . $year . ', (invh.tot_a_val+invh.tot_dis),0) ELSE IF(month(invh.date_book)=' . $monthNumber . ' AND year(invh.date_book)=' . $year . ', (invh.tot_a_val*`invh_cd_ratio`.`d_ratio`+invh.tot_dis*`invh_cd_ratio`.`d_ratio`),0) END) AS `' . $monthName . '-Total`';
        } else {
            $str2 = 'SUM(CASE WHEN (tbl_mst_geography.range_id!=3) THEN IF(month(invh.date_book)=' . $monthNumber . ' AND year(invh.date_book)=' . $year . ', (invh.tot_a_val+invh.tot_dis),0) ELSE IF(month(invh.date_book)=' . $monthNumber . ' AND year(invh.date_book)=' . $year . ', (invh.tot_a_val*`invh_cd_ratio`.`c_ratio`+invh.tot_dis*`invh_cd_ratio`.`c_ratio`),0) END) AS `' . $monthName . '-Total`';
        }
...
WHERE invh.date_book>=\'' . date('Y-m-01', strtotime($datepickermonth . ' -6 month')) . '\' AND invh.date_book<=\'' . date('Y-m-t', strtotime($datepickermonth)) . '\' AND invh.b_a=\''.$bookingAct.'\' ' . $str . '
GROUP BY tbl_mst_area.area_name,agency_mst.ag_name,invh.ag_cd,invh.cd
ORDER BY tbl_mst_region.id,tbl_mst_area.display_order,tbl_mst_area.area_name,agency_mst.ag_name,invh.ag_cd,cd');
        $result = $q->result_array();
        //echo $this->db->last_query();
    ...
    function getDailySalesCategoryNewDemarcation($area = null, $range = null, $datepickermonth = null, $category = null, $type = 'value',$bookingAct = 'A') {
        ...
        $qtyStri = ' AND invd.a_Qty<>0 AND invh.b_a=\''.$bookingAct.'\' AND invh.tot_a_val<>0 AND invh.date_actual>=\'' . date('Y-m-01', strtotime($datepickermonth . ' -6 month')) . '\' AND invh.date_actual<=\'' . date('Y-m-t', strtotime($datepickermonth)).'\' ';
        if($bookingAct=='B'){
            $qtyStri = ' AND invh.date_book>=\'' . date('Y-m-01', strtotime($datepickermonth . ' -6 month')) . '\' AND invh.date_book<=\'' . date('Y-m-t', strtotime($datepickermonth)).'\' ';

            for ($n = 1; $n <= date('t', strtotime($datepickermonth)); $n++) {
            if ($type == 'value') {
                $strQ .= 'SUM(IF(month(invh.date_book)=' . $monthNumber . ' AND year(invh.date_book)=' . $year . ' AND day(invh.date_book)=' . $n . ', (invd.a_Qty*invd.up),0)) AS `' . $monthName . '-' . $n . '`,';
                $strQ .= 'SUM(IF(month(invh.date_book)=' . $monthNumber . ' AND year(invh.date_book)=' . $year . ' AND day(invh.date_book)=' . $n . ' AND invh.b_a = \'A\', (invd.a_Qty*invd.up),0)) AS `' . $monthName . '-' . $n . '-A`,';
            } else {
                $strQ .= 'SUM(IF(month(invh.date_book)=' . $monthNumber . ' AND year(invh.date_book)=' . $year . ' AND day(invh.date_book)=' . $n . ', (invd.a_Qty*item_mst.pack),0)) AS `' . $monthName . '-' . $n . '`,';

                $strQ .= 'SUM(IF(month(invh.date_book)=' . $monthNumber . ' AND year(invh.date_book)=' . $year . ' AND day(invh.date_book)=' . $n . ' AND invh.b_a = \'A\', (invd.a_Qty*item_mst.pack),0)) AS `' . $monthName . '-' . $n . '-A`,';
            }
            $strQ .= 'COUNT(DISTINCT CASE WHEN (month(invh.date_book)=' . $monthNumber . ' AND year(invh.date_book)=' . $year . ' AND day(invh.date_book)=' . $n . ') THEN shop_mst.Auto END) AS `' . $monthName . '-' . $n . '-pc`,';

            $strQ .= 'COUNT(DISTINCT CASE WHEN (month(invh.date_book)=' . $monthNumber . ' AND year(invh.date_book)=' . $year . ' AND day(invh.date_book)=' . $n . ' AND invh.b_a = \'A\') THEN shop_mst.Auto END) AS `' . $monthName . '-' . $n . '-pc-A`,';
        }
        $strBack = '';
        for ($k = 1; $k <= 6; $k++) {
            $monthNumberBack = date('m', strtotime($datepickermonth . ' -' . $k . ' month'));
            ...
            $yearBack = date('Y', strtotime($datepickermonth . ' -' . $k . ' month'));
            if ($type == 'value') {
                $strBack .= ' SUM(IF(month(invh.date_book)=' . $monthNumberBack . ' AND year(invh.date_book)=' . $yearBack . ', invd.a_Qty*invd.up,0)) AS `' . $monthNameBack . '-Total`, ';
            } else {
                $strBack .= ' SUM(IF(month(invh.date_book)=' . $monthNumberBack . ' AND year(invh.date_book)=' . $yearBack . ', invd.a_Qty*item_mst.pack,0)) AS `' . $monthNameBack . '-Total`, ';
            }
        }

        $strK = '';
        if ($type == 'value') {
            $strK = 'SUM(IF(month(invh.date_book)=' . $monthNumber . ' AND year(invh.date_book)=' . $year . ', (invd.a_Qty*invd.up),0)) AS `' . $monthName . '-Total` ';
            $strK .= ' , SUM(IF(month(invh.date_book)=' . $monthNumber . ' AND year(invh.date_book)=' . $year . ' AND invh.b_a = \'A\', (invd.a_Qty*invd.up),0)) AS `' . $monthName . '-Total-A` ';
        } else {
            $strK = 'SUM(IF(month(invh.date_book)=' . $monthNumber . ' AND year(invh.date_book)=' . $year . ', (invd.a_Qty*item_mst.pack),0)) AS `' . $monthName . '-Total` ';
            $strK .= ' , SUM(IF(month(invh.date_book)=' . $monthNumber . ' AND year(invh.date_book)=' . $year . ' AND invh.b_a = \'A\', (invd.a_Qty*item_mst.pack),0)) AS `' . $monthName . '-Total-A` ';
        }
...
WHERE  tbl_mst_item_category_purpose.id=3 AND tbl_mst_item_category.id=' . $category .''. $qtyStri.'  ' . $str . '
...
ORDER BY tbl_mst_region.id,tbl_mst_area.display_order,tbl_mst_area.area_name,agency_mst.ag_name,invh.ag_cd,cd');
    ...
    function getTotalSalesandPcNewDemarcation($area = null, $range = null, $datepickermonth = null,$bookingAct = 'A') {
        $str = '';
        $strBack = '';
        ...
        $qtyStri = 'invh.date_actual>=\'' . date('Y-m-01', strtotime($datepickermonth . ' -6 month')) . '\' AND invh.date_actual<=\'' . date('Y-m-t', strtotime($datepickermonth)) .'\' AND invh.b_a=\''.$bookingAct.'\' AND invh.tot_a_val<>0 ';
         $query = 'select  
            ' . $strBack . '
            a.ag_cd
from (SELECT invh.ag_cd AS ag_cd,invh.date_actual AS dates, COUNT(DISTINCT shop_mst.Auto) AS pc
...
GROUP BY invh.ag_cd,invh.date_actual ) a GROUP BY a.ag_cd';
        if($bookingAct=='B'){
            $qtyStri = 'invh.date_book>=\'' . date('Y-m-01', strtotime($datepickermonth . ' -6 month')) . '\' AND invh.date_book<=\'' . date('Y-m-t', strtotime($datepickermonth)) .'\'';

            $query = 'select  
            ' . $strBack . '
            a.ag_cd
from (SELECT invh.ag_cd AS ag_cd,invh.date_book AS dates, COUNT(DISTINCT shop_mst.Auto) AS pc
FROM invh 
INNER JOIN shop_mst ON invh.ag_cd=shop_mst.sh_ag_cd AND invh.ro_cd=shop_mst.sh_ro_cd AND invh.sh_cd=shop_mst.sh_cd 
INNER JOIN agency_mst ON invh.ag_cd=agency_mst.ag_cd 
...
WHERE '. $qtyStri.' ' . $str . '
GROUP BY invh.ag_cd,invh.date_book ) a GROUP BY a.ag_cd';
        }
    ...
    function getTotalSalesandPcCategoryNewDemarcation($area = null, $range = null, $datepickermonth = null, $category = null,$bookingAct='A') {
        $str = '';
        if (!empty($area) && isset($area) && $area != null && $area != -1) {
            $str .= ' AND tbl_mst_area.id=' . $area . ' ';
        }
        ...
        $qtyStri = ' AND invh.b_a=\''.$bookingAct.'\' ';
        if($bookingAct=='B'){
            $qtyStri = '';
        }
...
WHERE invd.a_Qty<>0 AND tbl_mst_item_category_purpose.id=3 AND tbl_mst_item_category.id=' . $category . ' AND invh.date_actual>=\'' . date('Y-m-01', strtotime($datepickermonth . ' -6 month')) . '\' AND invh.date_actual<=\'' . date('Y-m-t', strtotime($datepickermonth))  .'\''. $qtyStri.' AND invh.tot_a_val<>0 ' . $str . '
GROUP BY invh.ag_cd,invh.date_actual ) a GROUP BY a.ag_cd';
        //echo $query; die();
        $result = $this->db->query($query)->result_array();
