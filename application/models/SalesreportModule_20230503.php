...
SUM(IF(month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=12,  (invh.tot_a_val+invh.tot_dis),0)) AS `April-12`,
SUM(IF(month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=13,  (invh.tot_a_val+invh.tot_dis),0)) AS `April-13`,
SUM(IF(month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=14,  (invh.tot_a_val+invh.tot_dis),0)) AS `April-14`,
SUM(IF(month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=15,  (invh.tot_a_val+invh.tot_dis),0)) AS `April-15`,
SUM(IF(month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=16,  (invh.tot_a_val+invh.tot_dis),0)) AS `April-16`,
SUM(IF(month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=17,  (invh.tot_a_val+invh.tot_dis),0)) AS `April-17`,
SUM(IF(month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=18,  (invh.tot_a_val+invh.tot_dis),0)) AS `April-18`,
SUM(IF(month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=19,  (invh.tot_a_val+invh.tot_dis),0)) AS `April-19`,
SUM(IF(month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=20,  (invh.tot_a_val+invh.tot_dis),0)) AS `April-20`,
SUM(IF(month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=21,  (invh.tot_a_val+invh.tot_dis),0)) AS `April-21`,
SUM(IF(month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=22,  (invh.tot_a_val+invh.tot_dis),0)) AS `April-22`,
SUM(IF(month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=23,  (invh.tot_a_val+invh.tot_dis),0)) AS `April-23`,
SUM(IF(month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=24,  (invh.tot_a_val+invh.tot_dis),0)) AS `April-24`,
SUM(IF(month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=25,  (invh.tot_a_val+invh.tot_dis),0)) AS `April-25`,
SUM(IF(month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=26,  (invh.tot_a_val+invh.tot_dis),0)) AS `April-26`,
SUM(IF(month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=27,  (invh.tot_a_val+invh.tot_dis),0)) AS `April-27`,
SUM(IF(month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=28,  (invh.tot_a_val+invh.tot_dis),0)) AS `April-28`,
SUM(IF(month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=29,  (invh.tot_a_val+invh.tot_dis),0)) AS `April-29`,
SUM(IF(month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=30,  (invh.tot_a_val+invh.tot_dis),0)) AS `April-30`,

COUNT(DISTINCT CASE WHEN (month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=1) THEN shop_mst.Auto END) AS `April-01-pc`,
COUNT(DISTINCT CASE WHEN (month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=2) THEN shop_mst.Auto END) AS `April-02-pc`,
COUNT(DISTINCT CASE WHEN (month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=3) THEN shop_mst.Auto END) AS `April-03-pc`,
COUNT(DISTINCT CASE WHEN (month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=4) THEN shop_mst.Auto END) AS `April-04-pc`,
COUNT(DISTINCT CASE WHEN (month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=5) THEN shop_mst.Auto END) AS `April-05-pc`,
COUNT(DISTINCT CASE WHEN (month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=6) THEN shop_mst.Auto END) AS `April-06-pc`,
COUNT(DISTINCT CASE WHEN (month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=7) THEN shop_mst.Auto END) AS `April-07-pc`,
COUNT(DISTINCT CASE WHEN (month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=8) THEN shop_mst.Auto END) AS `April-08-pc`,
COUNT(DISTINCT CASE WHEN (month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=9) THEN shop_mst.Auto END) AS `April-09-pc`,
COUNT(DISTINCT CASE WHEN (month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=10) THEN shop_mst.Auto END) AS `April-10-pc`,
COUNT(DISTINCT CASE WHEN (month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=11) THEN shop_mst.Auto END) AS `April-11-pc`,
COUNT(DISTINCT CASE WHEN (month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=12) THEN shop_mst.Auto END) AS `April-12-pc`,
COUNT(DISTINCT CASE WHEN (month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=13) THEN shop_mst.Auto END) AS `April-13-pc`,
COUNT(DISTINCT CASE WHEN (month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=14) THEN shop_mst.Auto END) AS `April-14-pc`,
COUNT(DISTINCT CASE WHEN (month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=15) THEN shop_mst.Auto END) AS `April-15-pc`,
COUNT(DISTINCT CASE WHEN (month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=16) THEN shop_mst.Auto END) AS `April-16-pc`,
COUNT(DISTINCT CASE WHEN (month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=17) THEN shop_mst.Auto END) AS `April-17-pc`,
COUNT(DISTINCT CASE WHEN (month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=18) THEN shop_mst.Auto END) AS `April-18-pc`,
COUNT(DISTINCT CASE WHEN (month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=19) THEN shop_mst.Auto END) AS `April-19-pc`,
COUNT(DISTINCT CASE WHEN (month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=20) THEN shop_mst.Auto END) AS `April-20-pc`,
COUNT(DISTINCT CASE WHEN (month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=21) THEN shop_mst.Auto END) AS `April-21-pc`,
COUNT(DISTINCT CASE WHEN (month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=22) THEN shop_mst.Auto END) AS `April-22-pc`,
COUNT(DISTINCT CASE WHEN (month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=23) THEN shop_mst.Auto END) AS `April-23-pc`,
COUNT(DISTINCT CASE WHEN (month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=24) THEN shop_mst.Auto END) AS `April-24-pc`,
COUNT(DISTINCT CASE WHEN (month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=25) THEN shop_mst.Auto END) AS `April-25-pc`,
COUNT(DISTINCT CASE WHEN (month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=26) THEN shop_mst.Auto END) AS `April-26-pc`,
COUNT(DISTINCT CASE WHEN (month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=27) THEN shop_mst.Auto END) AS `April-27-pc`,
COUNT(DISTINCT CASE WHEN (month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=28) THEN shop_mst.Auto END) AS `April-28-pc`,
COUNT(DISTINCT CASE WHEN (month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=29) THEN shop_mst.Auto END) AS `April-29-pc`,
COUNT(DISTINCT CASE WHEN (month(invh.date_actual)=4 AND year(invh.date_actual)=2023 AND day(invh.date_actual)=30) THEN shop_mst.Auto END) AS `April-30-pc`,
