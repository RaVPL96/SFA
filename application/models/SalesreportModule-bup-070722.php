...
class SalesreportModule extends CI_Model {
    ...
    /////////////////////////////
    /*sandun*/
    function getItemsPcTotals($areaID = null, $territoryID = null, $routeID = null, $cat = null, $billingType = null, $dateFrom = null, $dateTo = null, $reportType = 'summery',$channel_id=1) {
        if ($reportType == 'summery_area') {//area wise sales summery data
            if ($billingType == 'A') {                
        ...
        if ($billingType == 'A') {
            ...
            if (!empty($cat) && isset($cat) && $cat != null && $cat != 'null') {
                $this->db->where('`item_mst`.`cat`', $cat);
            } else {
                $this->db->group_by('item_mst.des');
            }
            if ($reportType == 'summery_area' || $reportType == 'summery' || $reportType == 'summery_territory') {
