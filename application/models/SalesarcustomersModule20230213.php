...
FROM `invh`
INNER JOIN shop_mst ON invh.ag_cd=shop_mst.sh_ag_cd AND invh.ro_cd=shop_mst.sh_ro_cd AND invh.sh_cd=shop_mst.sh_cd
WHERE invh.date_actual>=\'2022-11-01\' AND invh.date_actual<=\'2023-01-30\' AND invh.b_a=\'A\' AND invh.tot_a_val!=0 ) bill_shop','shop_mst.Auto=bill_shop.Auto','LEFT');
        $this->db->where(array('shop_mst.sh_stat'=>0, 'bill_shop.Auto IS NULL'));
        $q = $this->db->get();
        $result = $q->result_array();
        return $result;
    }
