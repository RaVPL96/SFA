...
class SalesreportModule extends CI_Model {
    ...
    function getTarget($tyear, $tmonth) {
        $this->db->select('`area_cd`, `ag_cd`, `t_year`, `t_mon`, `area_name`, `ag_name`, `c_target`, `d_target`, `a_target`, `b_target`, `s_target`, `acs_pc_target`, `bd_pc_target`, `wd`, `p_wd`, `auto`');
