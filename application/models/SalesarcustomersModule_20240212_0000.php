...
//echo $this->db->last_query();
    ...
    //GET OUTLET UPDATE LIST TO UPDATE
    /*
    function getUpdateCustomers($areaid = null, $id = null, $territory_id = null, $route_id = null, $isact = null, $rpt_type = 'details') {
        if ($rpt_type == 'details') {
            if (!empty($id) && isset($id)) {
                $this->db->select('`tbl_trans_outlet_update`.`is_updated`, `tbl_trans_outlet_update`.`address_1` AS `address_1_up`, `tbl_trans_outlet_update`.`address_2` AS `address_2_up`, `tbl_trans_outlet_update`.`address_3` AS `address_3_up`, `tbl_trans_outlet_update`.`contact_person` AS `contact_person_up`, `tbl_trans_outlet_update`.`telephone` AS `telephone_up`, `tbl_trans_outlet_update`.`shop_type` AS `shop_type_up`, `tbl_trans_outlet_update`.`image` AS `image_up`, `tbl_trans_outlet_update`.`latitude` AS `latitude_up`, `tbl_trans_outlet_update`.`longitude` AS `longitude_up`, `tbl_trans_outlet_update`.`updated_by`, `tbl_trans_outlet_update`.`updated_date`, `tbl_trans_outlet_update`.`updated_time`, `tbl_trans_outlet_update`.`is_approved`, `tbl_trans_outlet_update`.`approved_by`, `tbl_trans_outlet_update`.`approved_date`,`tbl_mst_outlet`.`id`, `tbl_mst_outlet`.`reference_code`, `tbl_mst_outlet`.`name`, `tbl_mst_outlet`.`address_1`, `tbl_mst_outlet`.`address_2`, `tbl_mst_outlet`.`address_3`, `tbl_mst_outlet`.`contact_person`, `tbl_mst_outlet`.`telephone`, `tbl_mst_outlet`.`mobile`,`tbl_mst_outlet_category`.`id` AS `outlet_category_id`, `tbl_mst_outlet_category`.`name` AS `shop_type_name`, `created_date`, `tbl_mst_outlet`.`created_by`, `tbl_mst_outlet`.`display_order`, `tbl_mst_outlet`.`latitude`, `tbl_mst_outlet`.`longitude`, `tbl_mst_outlet`.`is_act`, `tbl_mst_outlet`.`is_new`, `tbl_mst_outlet`.`allowed_to`,`tbl_mst_outlet`.`duplicate_of`, `tbl_mst_outlet`.`image`,`tbl_mst_route_link_outlet`.`outlet_code`,`tbl_mst_territory`.`reference_code` AS `territory_reference_code`,`tbl_mst_route`.`reference_code` AS `route_reference_code`');
            } else {
                $this->db->select('`tbl_trans_outlet_update`.`is_updated`, `tbl_trans_outlet_update`.`address_1` AS `address_1_up`, `tbl_trans_outlet_update`.`address_2` AS `address_2_up`, `tbl_trans_outlet_update`.`address_3` AS `address_3_up`, `tbl_trans_outlet_update`.`contact_person` AS `contact_person_up`, `tbl_trans_outlet_update`.`telephone` AS `telephone_up`, `tbl_trans_outlet_update`.`shop_type` AS `shop_type_up`, `tbl_trans_outlet_update`.`image` AS `image_up`, `tbl_trans_outlet_update`.`latitude` AS `latitude_up`, `tbl_trans_outlet_update`.`longitude` AS `longitude_up`, `tbl_trans_outlet_update`.`updated_by`, `tbl_trans_outlet_update`.`updated_date`, `tbl_trans_outlet_update`.`updated_time`, `tbl_trans_outlet_update`.`is_approved`, `tbl_trans_outlet_update`.`approved_by`, `tbl_trans_outlet_update`.`approved_date`,`tbl_mst_outlet`.`id`, `tbl_mst_outlet`.`reference_code`, `tbl_mst_outlet`.`name`, `tbl_mst_outlet`.`address_1`, `tbl_mst_outlet`.`address_2`, `tbl_mst_outlet`.`address_3`, `tbl_mst_outlet`.`contact_person`, `tbl_mst_outlet`.`telephone`, `tbl_mst_outlet`.`mobile`,`tbl_mst_outlet_category`.`id` AS `outlet_category_id`, `tbl_mst_outlet_category`.`name` AS `shop_type_name`, `created_date`, `tbl_mst_outlet`.`created_by`, `tbl_mst_outlet`.`display_order`, `tbl_mst_outlet`.`latitude`, `tbl_mst_outlet`.`longitude`, `tbl_mst_outlet`.`is_act`, `tbl_mst_outlet`.`is_new`, `tbl_mst_outlet`.`allowed_to`,`tbl_mst_outlet`.`duplicate_of`, \'aa\' AS `image`,`tbl_mst_route_link_outlet`.`outlet_code`,`tbl_mst_territory`.`reference_code` AS `territory_reference_code`,`tbl_mst_route`.`reference_code` AS `route_reference_code`,`tbl_mst_route_link_outlet`.`display_order_in_route`,`tbl_mst_rep_link_territory_agent`.`range_id`,`tbl_mst_rep_link_territory_agent`.`range_name`');
            }
        } else {//summery of progress
            $this->db->select('`tbl_mst_area`.`area_name`,`tbl_mst_territory`.`territory_name`, COUNT(`tbl_trans_outlet_update`.`outlet_id`) AS TOTAL,COUNT(IF(`tbl_trans_outlet_update`.`is_updated`=0,`tbl_trans_outlet_update`.`outlet_id`,null)) AS PENDING_TO_COMPLETE,COUNT(IF(`tbl_trans_outlet_update`.`is_updated`=1,`tbl_trans_outlet_update`.`outlet_id`,null)) AS COMPLETED, COUNT(IF(`tbl_trans_outlet_update`.`is_approved`=1,`tbl_trans_outlet_update`.`outlet_id`,null)) AS APPROVED, COUNT(IF(`tbl_trans_outlet_update`.`is_approved`=0 AND `tbl_trans_outlet_update`.`is_updated`=1,`tbl_trans_outlet_update`.`outlet_id`,null)) AS PENDINGTO_APPROVED,COUNT(IF(`tbl_trans_outlet_update`.`is_updated`=1 AND `tbl_mst_rep_link_territory_agent`.`range_name`=\'C\',`tbl_trans_outlet_update`.`outlet_id`,null)) AS `C`,COUNT(IF(`tbl_trans_outlet_update`.`is_updated`=1 AND `tbl_mst_rep_link_territory_agent`.`range_name`=\'D\',`tbl_trans_outlet_update`.`outlet_id`,null)) AS `D`,COUNT(IF(`tbl_trans_outlet_update`.`is_updated`=1 AND `tbl_mst_rep_link_territory_agent`.`range_name`=\'B\',`tbl_trans_outlet_update`.`outlet_id`,null)) AS `B`,COUNT(IF(`tbl_trans_outlet_update`.`is_updated`=1 AND `tbl_mst_rep_link_territory_agent`.`range_name`=\'R\',`tbl_trans_outlet_update`.`outlet_id`,null)) AS `R`,COUNT(IF(`tbl_trans_outlet_update`.`is_updated`=1 AND `tbl_mst_rep_link_territory_agent`.`range_name`=\'S\',`tbl_trans_outlet_update`.`outlet_id`,null)) AS `S`');
            $this->db->group_by('`tbl_mst_area`.`id`,`tbl_mst_territory`.`id`');
        }
        $this->db->from('`tbl_trans_outlet_update`');
        $this->db->join('`tbl_mst_rep_link_territory_agent`', '`tbl_trans_outlet_update`.`updated_by`=`tbl_mst_rep_link_territory_agent`.`rep_username`', 'LEFT');
        $this->db->join('`tbl_mst_outlet`', '`tbl_trans_outlet_update`.`outlet_id`=`tbl_mst_outlet`.`id`', 'INNER');
        $this->db->join('`tbl_mst_outlet_category`', '`tbl_mst_outlet`.`shop_type`=`tbl_mst_outlet_category`.`id`', 'INNER');
        $this->db->join('`tbl_mst_route_link_outlet`', '`tbl_mst_outlet`.`id`=`tbl_mst_route_link_outlet`.`outlet_id`', 'INNER');
        $this->db->join('`tbl_mst_route`', '`tbl_mst_route_link_outlet`.`route_id`=`tbl_mst_route`.`id`', 'INNER');
        $this->db->join('`tbl_mst_territory_link_route`', '`tbl_mst_route`.`id`=`tbl_mst_territory_link_route`.`route_id`', 'INNER');
        ...
        $this->db->order_by('`tbl_mst_area`.`id`,`tbl_mst_territory`.`id`,`tbl_trans_outlet_update`.`is_updated`,`tbl_mst_route`.`display_order`,`tbl_mst_route_link_outlet`.`display_order_in_route`');
        $q = $this->db->get();
        //echo $this->db->last_query();
        if (!empty($id) && isset($id)) {
            $result = $q->row();
    ...
    */
    ...
    function getUpdateCustomers($areaid = null, $id = null, $territory_id = null, $route_id = null, $isact = null, $rpt_type = 'details',$rangeid=null) {
        if ($rpt_type == 'details') {
            if (!empty($id) && isset($id)) {
                $this->db->select('`tbl_trans_shop_update`.`is_updated`, `tbl_trans_shop_update`.`address_1` AS `address_1_up`, `tbl_trans_shop_update`.`address_2` AS `address_2_up`, `tbl_trans_shop_update`.`address_3` AS `address_3_up`, `tbl_trans_shop_update`.`contact_person` AS `contact_person_up`, `tbl_trans_shop_update`.`telephone` AS `telephone_up`, `tbl_trans_shop_update`.`shop_type` AS `shop_type_up`, `tbl_trans_shop_update`.`image` AS `image_up`, `tbl_trans_shop_update`.`latitude` AS `latitude_up`, `tbl_trans_shop_update`.`longitude` AS `longitude_up`, `tbl_trans_shop_update`.`updated_by`, `tbl_trans_shop_update`.`updated_date`, `tbl_trans_shop_update`.`updated_time`, `tbl_trans_shop_update`.`is_approved`, `tbl_trans_shop_update`.`approved_by`, `tbl_trans_shop_update`.`approved_date`,`tbl_mst_outlet`.`id`, `tbl_mst_outlet`.`reference_code`, `tbl_mst_outlet`.`name`, `tbl_mst_outlet`.`address_1`, `tbl_mst_outlet`.`address_2`, `tbl_mst_outlet`.`address_3`, `tbl_mst_outlet`.`contact_person`, `tbl_mst_outlet`.`telephone`, `tbl_mst_outlet`.`mobile`,`tbl_mst_outlet_category`.`id` AS `outlet_category_id`, `tbl_mst_outlet_category`.`name` AS `shop_type_name`, `created_date`, `tbl_mst_outlet`.`created_by`, `tbl_mst_outlet`.`display_order`, `tbl_mst_outlet`.`latitude`, `tbl_mst_outlet`.`longitude`, `tbl_mst_outlet`.`is_act`, `tbl_mst_outlet`.`is_new`, `tbl_mst_outlet`.`allowed_to`,`tbl_mst_outlet`.`duplicate_of`, `tbl_mst_outlet`.`image`,`tbl_mst_route_link_outlet`.`outlet_code`,`tbl_mst_territory`.`reference_code` AS `territory_reference_code`,`tbl_mst_route`.`reference_code` AS `route_reference_code`');
            } else {
                $this->db->select('`tbl_trans_shop_update`.`is_updated`, `tbl_trans_shop_update`.`address_1` AS `address_1_up`, `tbl_trans_shop_update`.`address_2` AS `address_2_up`, `tbl_trans_shop_update`.`address_3` AS `address_3_up`, `tbl_trans_shop_update`.`contact_person` AS `contact_person_up`, `tbl_trans_shop_update`.`telephone` AS `telephone_up`, `tbl_trans_shop_update`.`shop_type` AS `shop_type_up`, `tbl_trans_shop_update`.`image` AS `image_up`, `tbl_trans_shop_update`.`latitude` AS `latitude_up`, `tbl_trans_shop_update`.`longitude` AS `longitude_up`, `tbl_trans_shop_update`.`updated_by`, `tbl_trans_shop_update`.`updated_date`, `tbl_trans_shop_update`.`updated_time`, `tbl_trans_shop_update`.`is_approved`, `tbl_trans_shop_update`.`approved_by`, `tbl_trans_shop_update`.`approved_date`,`tbl_mst_outlet`.`id`, `tbl_mst_outlet`.`reference_code`, `tbl_mst_outlet`.`name`, `tbl_mst_outlet`.`address_1`, `tbl_mst_outlet`.`address_2`, `tbl_mst_outlet`.`address_3`, `tbl_mst_outlet`.`contact_person`, `tbl_mst_outlet`.`telephone`, `tbl_mst_outlet`.`mobile`,`tbl_mst_outlet_category`.`id` AS `outlet_category_id`, `tbl_mst_outlet_category`.`name` AS `shop_type_name`, `created_date`, `tbl_mst_outlet`.`created_by`, `tbl_mst_outlet`.`display_order`, `tbl_mst_outlet`.`latitude`, `tbl_mst_outlet`.`longitude`, `tbl_mst_outlet`.`is_act`, `tbl_mst_outlet`.`is_new`, `tbl_mst_outlet`.`allowed_to`,`tbl_mst_outlet`.`duplicate_of`, \'aa\' AS `image`,`tbl_mst_route_link_outlet`.`outlet_code`,`tbl_mst_territory`.`reference_code` AS `territory_reference_code`,`tbl_mst_route`.`reference_code` AS `route_reference_code`,`tbl_mst_route_link_outlet`.`display_order_in_route`,`tbl_mst_rep_link_territory_agent`.`range_id`,`tbl_mst_rep_link_territory_agent`.`range_name`');
            }
        } else {//summery of progress
            $this->db->select('`tbl_mst_area`.`area_name`,`tbl_mst_territory`.`territory_name`, COUNT(`tbl_trans_shop_update`.`outlet_id`) AS TOTAL,COUNT(IF(`tbl_trans_shop_update`.`is_updated`=0,`tbl_trans_shop_update`.`outlet_id`,null)) AS PENDING_TO_COMPLETE,COUNT(IF(`tbl_trans_shop_update`.`is_updated`=1,`tbl_trans_shop_update`.`outlet_id`,null)) AS COMPLETED, COUNT(IF(`tbl_trans_shop_update`.`is_approved`=1,`tbl_trans_shop_update`.`outlet_id`,null)) AS APPROVED, COUNT(IF(`tbl_trans_shop_update`.`is_approved`=0 AND `tbl_trans_shop_update`.`is_updated`=1,`tbl_trans_shop_update`.`outlet_id`,null)) AS PENDINGTO_APPROVED,COUNT(IF(`tbl_trans_shop_update`.`is_updated`=1 AND `tbl_mst_rep_link_territory_agent`.`range_name`=\'C\',`tbl_trans_shop_update`.`outlet_id`,null)) AS `C`,COUNT(IF(`tbl_trans_shop_update`.`is_updated`=1 AND `tbl_mst_rep_link_territory_agent`.`range_name`=\'D\',`tbl_trans_shop_update`.`outlet_id`,null)) AS `D`,COUNT(IF(`tbl_trans_shop_update`.`is_updated`=1 AND `tbl_mst_rep_link_territory_agent`.`range_name`=\'B\',`tbl_trans_shop_update`.`outlet_id`,null)) AS `B`,COUNT(IF(`tbl_trans_shop_update`.`is_updated`=1 AND `tbl_mst_rep_link_territory_agent`.`range_name`=\'R\',`tbl_trans_shop_update`.`outlet_id`,null)) AS `R`,COUNT(IF(`tbl_trans_shop_update`.`is_updated`=1 AND `tbl_mst_rep_link_territory_agent`.`range_name`=\'S\',`tbl_trans_shop_update`.`outlet_id`,null)) AS `S`');
            $this->db->group_by('`tbl_mst_area`.`id`,`tbl_mst_territory`.`id`');
        }
        ...
        $this->db->join('`tbl_mst_outlet`', '`tbl_trans_shop_update`.`outlet_id`=`tbl_mst_outlet`.`id`', 'INNER');
        $this->db->join('`tbl_mst_outlet_category`', '`tbl_mst_outlet`.`shop_type`=`tbl_mst_outlet_category`.`id`', 'INNER');
        $this->db->join('`tbl_mst_route_link_outlet`', '`tbl_mst_outlet`.`id`=`tbl_mst_route_link_outlet`.`outlet_id`', 'INNER');
        $this->db->join('`tbl_mst_route`', '`tbl_mst_route_link_outlet`.`route_id`=`tbl_mst_route`.`id`', 'INNER');
        $this->db->join('`tbl_mst_territory_link_route`', '`tbl_mst_route`.`id`=`tbl_mst_territory_link_route`.`route_id`', 'INNER');
        ...
        //$this->db->join('`tbl_mst_area_link_territory`', '`tbl_mst_territory`.`id`=`tbl_mst_area_link_territory`.`territory_id`', 'INNER');
        //$this->db->join('`tbl_mst_area`', '`tbl_mst_area_link_territory`.`area_id`=`tbl_mst_area`.`id`', 'INNER');
        $this->db->join('tbl_mst_geography','tbl_mst_territory.id=tbl_mst_geography.territory_id AND `tbl_trans_shop_update`.`range_id`=tbl_mst_geography.range_id','INNER');
