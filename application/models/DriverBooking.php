                ...
                <div class="register-box-body">
                    ...
                    <form id="openacc" name="addem" novalidate="novalidate" action="<?= base_url('index.php/Logistics/saveDriverBook') ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" <?= $readonly ?> name="post[user][drivercost]" class="form-control" id="rateVehi" placeholder="Driver Cost" value="<?= $dcost ?> " onkeypress="return isNumberKey(this, event);"  required />
                            <span class="glyphicon glyphicon-usd form-control-feedback"></span>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        foreach ($ServiceList as $list) {
                            ...
                            $edit=" <a class=\"btn btn-primary btn-xs\" href=\"" . base_url("index.php/logistics/service/null/" . $list['id']) . "\">Edit</a>";
                            if ($list['status'] == 0) {
                                $str = '<span class="label label-warning">Booking</span>';
