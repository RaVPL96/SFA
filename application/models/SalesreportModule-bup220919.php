...
';
    ...
    /*$this->db->select('`item_mst`.`item`, `item_mst`.`des` SUM(`invd`.`a_Qty` as Actual_Qty SUM(`invd`.`up`*`invd`.`a_Qty` as Actual_Val');
        ...
        $this->db->JOIN('`invd`', '`item_mst`.`item`=`invd`.`item`', 'INNER');
        $this->db->JOIN('`invh`', '`invd`.`invno`=`invh`.`invno`', 'INNER');
        $this->db->where('item_mst.item="RMCM48HASM" or item_mst.item="RMCM48HAME" or item_mst.item="RMCM48HALA" or item_mst.item="RMCM48HAXL" or item_mst.item="RMCM2PCSSM" or									
        item_mst.item="RMCM2PCSME" or item_mst.item="RMCM2PCSLA" or item_mst.item="RMCM2PCSXL" or item_mst.item="RMCM4PCSSM" or item_mst.item="RMCM4PCSME" or									
        item_mst.item="RMCM4PCSLA" or item_mst.item="RMCM4PCSXL" or item_mst.item="DCHW030MCO" or item_mst.item="DCHW100MCO" or item_mst.item="DCCM012GDC" or									
        item_mst.item="DCCM020GDC" or item_mst.item="DCCM012GNC" or item_mst.item="RMCM48HASM" or item_mst.item="RMCM48HAME" or item_mst.item="RMCM48HALA" or									
        item_mst.item="RMCM48HAXL" or item_mst.item="RMCM2PCSSM" or item_mst.item="RMCM2PCSME" or item_mst.item="RMCM2PCSLA" or item_mst.item="RMCM2PCSXL" or									
        item_mst.item="RMCM4PCSSM" or item_mst.item="RMCM4PCSME" or item_mst.item="RMCM4PCSLA" or item_mst.item="RMCM4PCSXL" or item_mst.item="DCHW030MCO" or									
        item_mst.item="DCHW100MCO" or item_mst.item="DCCM012GDC" or item_mst.item="DCCM020GDC" or item_mst.item="DCCM020GNC" or item_mst.item="RMCM48HASM" or									
        item_mst.item="RMCM48HAME" or item_mst.item="RMCM48HALA" or item_mst.item="RMCM48HAXL" or item_mst.item="RMCM2PCSSM" or item_mst.item="RMCM2PCSME" or									
        item_mst.item="RMCM2PCSLA" or item_mst.item="RMCM2PCSXL" or item_mst.item="RMCM4PCSSM" or item_mst.item="RMCM4PCSME" or item_mst.item="RMCM4PCSLA" or									
        item_mst.item="RMCM4PCSXL" or item_mst.item="DCHW030MCO" or item_mst.item="DCHW100MCO" or item_mst.item="DCCM012GDC" or item_mst.item="DCCM020GDC" or									
        item_mst.item="DCCM012GSD" or item_mst.item="DCCM020GSD" or item_mst.item="DCCM060GSD" or item_mst.item="DCCM012GSF" or item_mst.item="DCCM020GSF" or									
        item_mst.item="DCCM060GSF" or item_mst.item="RMSW090MCL" or item_mst.item="DCSW090MTO" or item_mst.item="RMSW045GSC" or item_mst.item="DCCM130MBW" or									
        item_mst.item="RMYO01PDSI" or item_mst.item="RMYO02PDDO" or item_mst.item="RMYO10PDSU" or item_mst.item="DCYOSINGWI" or item_mst.item="DCYODOUBWI" or									
        item_mst.item="RMYO10PDWI" or item_mst.item="DCCM1219BH" or item_mst.item="DCCM1220BH" or item_mst.item="DCCM1221BH" or item_mst.item="DCCM1222BH" or									
        item_mst.item="DCCM010GKO" or item_mst.item="DCCMN10GKO" or item_mst.item="DCCMN10GAT" or item_mst.item="DCCMS10GAT" or item_mst.item="DCCM10MLRH" or									
        item_mst.item="DCCM15MLRH" or item_mst.item="DCCM25MLRH" or item_mst.item="DCDZ001DDC" or item_mst.item="DCDZ002DDS" or item_mst.item="DC-AS-10PD-DW" or item_mst.item="DC-AS-SING-DW" or item_mst.item="DC-PC-02PD-DW" or item_mst.item="DCPS10PDCF"');
        $this->db->where('`invh`.`date_actual`>=', $FromDate);
        $this->db->where('`invh`.`date_actual`<=', $ToDate);
        $this->db->where('`invh`.`b_a`="a"');
        $this->db->where('`invh`.`tot_a_val`<>0');
