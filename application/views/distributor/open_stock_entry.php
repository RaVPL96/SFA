...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Secondary Sales Opening Stock Entry
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label class="col-md-12 label label-default"> - ආරම්භක කොටස් මට්ටම </label>
                        <label class="col-md-12 label label-default"> - Opening Stock</label>
                        ...
                        <div class="col-md-6">
                            <form class="form-horizontal" id="OrderData" action="<?= base_url('salesoetransaction/SaveOrderentry') ?>" method="post">		
                                <div class="form-group">
                                    <label class="col-md-4">Stock Date <span class="text-red">*</span></label>
                                    <div class="col-md-8">
                        ...
                        <div class="col-md-12" style="width: 100%;   overflow-x: scroll;">
                            ...
                            $estimateNet = 0;
                            ?>
                            <table class="table table-bordered table-hover" style="overflow-x: scroll;clear:both;width: 100%; ">
                                <tr>
                                    <th>#</th>
                                    <th>Item Number</th>
                                    <th>Description</th>
                                    ...
                                    if (!empty($estimated) && isset($estimated)) {
                                        ...
                                        foreach ($estimated as $line) {
                                            ...
                                            <tr id="line<?= $count ?>">
                                                ...
                                                <td class="col-md-1"><div class="col-md-12"><input class="form-control text-right" name="estimatedamagepartqty[]" id="estimatedamagepartqty<?= $count ?>" type="text" value="<?= $pdqty ?>"></div></td>
                                                <td class="col-md-1"><div class="col-md-12"><input class="form-control text-right" type="text" name="estimatepartprice[]" id="estimatepartprice<?= $count ?>" value="<?= $pprice ?>" readonly="readonly"></div></td>
                                                <td class="col-md-1"><div class="col-md-12"><input class="form-control text-right" type="text" name="estimatepartpriceUnit[]" id="estimatepartpriceUnit<?= $count ?>" value="<?= $pprice ?>" readonly="readonly"></div></td>
                                        ...
                                        <tr id="line1">
                                            ...
                                            <td class="col-md-1"><div class="col-md-12"><input class="form-control text-right" name="estimatedamagepartqty[]" id="estimatedamagepartqty1" type="text" value="0"></div></td>
                                            <td class="col-md-1"><div class="col-md-12"><input class="form-control text-right" type="text" name="estimatepartprice[]" id="estimatepartprice1" value="0.00" readonly="readonly"></div></td>
                                            ...
                                            <td class="col-md-2"><div class="col-md-12"><input class="form-control text-right" type="text" name="estimatepartsubtotal[]" id="estimatepartsubtotal1" value="0.00" readonly="readonly"></div></td>
                                        </tr>
                                        <?php
                                    }
                                    ?>
            ...
            <script type="text/javascript">
                ...
                {    // open popup window and pass range id        
                    var itemRow = id;
                    var range = $('#sbRange').val();
                    window.open('<?= base_url('index.php/items/getItemListPopup/') ?>' + itemRow + '/' + range, 'popuppage', 'width=650,toolbar=1,resizable=1,scrollbars=yes,height=600,top=100,left=100');
                }
                ...
                function sumThemUp() {
                    ...
                    $("input[type='hidden'][name^='rowid']").each(function () {
                        ...
                        var estimatedamagepartqty = 'estimatedamagepartqty' + rid;
                        var Subtot = (parseFloat(document.getElementById(estimatepartqty).value)+parseFloat(document.getElementById(estimatedamagepartqty).value)) * parseFloat(document.getElementById(estimatepartprice).value);
                        document.getElementById(estimatepartsubtot).value = Subtot.toFixed(2);
                        sum = sum + Subtot;
                    });
                    /*
                ...
                function addItem() {
                    ...
                    var htmlTxt = '<tr id="line' + lineCount + '">' +
                            ...
                            '<td class="col-md-1"><div class="col-md-12"><input class="form-control text-right" name="estimatedamagepartqty[]" id="estimatedamagepartqty' + lineCount + '" type="text" value="0"></div></td>' +
                            '<td class="col-md-1"><div class="col-md-12"><input class="form-control text-right" type="text" name="estimatepartprice[]" id="estimatepartprice' + lineCount + '" value="0.00" readonly="readonly"></div></td>' +
                            ...
                            '<td class="col-md-2"><div class="col-md-12"><input class="form-control text-right" type="text" name="estimatepartsubtotal[]" id="estimatepartsubtotal' + lineCount + '" readonly="readonly" value="0.00"></div></td>' +
                            '</tr>';
                ...
                $("input[type='text'][name^='estimatedamagepartqty']").on('keyup', function () {
                    sumThemUp();
                });
                $(document).on('change', "input[type='text'][name^='estimatedamagepartqty']", function () {
                    sumThemUp();
                });
