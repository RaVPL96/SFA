                    ...
                    <fieldset>
                        <div class="box">
                            ...
                            if (!empty($DistributorWarehouse) && isset($DistributorWarehouse)) {
                                ...
                                $wharehouse_name_lat = $DistributorWarehouse->latitude;
                                $wharehouse_name_long = $DistributorWarehouse->longitude;
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    latitude start with 6.
                                    <input type="text" name="sop[agency_warehouse_lat]" class="form-control" value="<?= $wharehouse_name_lat ?>" placeholder="Enter Name of Warehouse Latitude">
                                </div>
                                <div class="form-group">
                                    longitude start with 79. 
                                    <input type="text" name="sop[agency_warehouse_long]" class="form-control" value="<?= $wharehouse_name_long ?>" placeholder="Enter Name of Warehouse Longitude">
                                </div>
                                <div class="form-group"> 
                                    <div class="checkbox icheck" style="padding-left: 20px;">
