            ...
            <div class="col-md-4">
                ...
                <div class="register-box-body">
                    ...
                    if (!empty($service) && isset($service)) {
                        ...
                        $driverid = $service->nic;

                        $requestername = $service->requester_name;

                        $dcost = $service->driver_cost ;
                    ...
                    <form id="openacc" name="addem" novalidate="novalidate" action="<?= base_url('index.php/Logistics/saveDriverBook') ?>" method="post" enctype="multipart/form-data">

                        <div class="form-group has-feedback">

                            <select class="form-control" id="Company" name="post[user][company]" required >
                        ...
                        <div class="form-group has-feedback">
                            <input type="text" name="post[user][reason]" class="form-control" id="Reason" placeholder="Reason" value="<?= $reason ?>" required/>
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" <?= $readonly ?> name="post[user][drivercost]" class="form-control" id="DriverCost" placeholder="Driver Cost" value="<?= $dcost ?> " onkeypress="return isNumberKey(this, event);"  required />
                            <span class="glyphicon glyphicon-usd form-control-feedback"></span>
                        ...
                        if (!empty($serviceOther) && isset($serviceOther)) {
                            foreach ($serviceOther as $s) {
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <input type="text" <?= $readonly ?> name="post[user][cost]" class="form-control" id="DCost" placeholder="Cost" value="<?= $s['cost'] ?>" onkeypress="return isNumberKey(this, event);"  />
                                    <span class="glyphicon glyphicon-usd form-control-feedback"></span>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        foreach ($ServiceList as $list) {
                            ...
                            $edit=" <a class=\"btn btn-primary btn-xs\" href=\"" . base_url("index.php/logistics/driverBook/null/" . $list['id']) . "\">Edit</a>";
                            if ($list['status'] == 0) {
                                $str = '<span class="label label-warning">Booking</span>';
...
<script>
    $('#DCost').on('keyup change', function () {
        calTotal();
