                ...
                <div class="register-box-body">
                    ...
                    <form id="openacc" novalidate="novalidate" action="<?= base_url('index.php/Logistics/saveService') ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" name="post[user][startmileage]" class="form-control" id="StartMileage" placeholder="Start Mileage" value="<?= $startmileage ?>" required/>
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" name="post[user][endmileage]" class="form-control" id="EndMileage" placeholder="End Mileage" value="<?= $endmileage ?>" required />
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" <?= $readonly ?> name="post[user][systemmileage]" class="form-control" id="SystemMileage" placeholder="System Mileage" value="<?= $systemmileage ?>" required />
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" <?= $readonly ?> name="post[user][totalcost]" class="form-control" id="TotalCost" placeholder="Total Cost" value="<?= $totalcost ?>" />
