                ...
                <div class="register-box-body">
                    ...
                    <form id="openacc" name="addem" novalidate="novalidate" action="<?= base_url('index.php/Logistics/saveService') ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" <?= $readonly ?> name="post[user][rate]" class="form-control" id="rateVehi" placeholder="Vehicle Rate" value=" " onkeypress="return isNumberKey(this, event);"  required readonly />
