            ...
            <div class="col-md-4">
                ...
                <div class="register-box-body">
                    ...
                    if (!empty($service) && isset($service)) {
                        ...
                        $companyId=$service->company_name;
                    ...
                    <form id="openacc" name="addem" novalidate="novalidate" action="<?= base_url('index.php/Logistics/driverBook') ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" <?= $readonly ?> name="post[user][rate]" class="form-control" id="rateVehi" placeholder="Vehicle Rate" value="<?= $rate ?> " onkeypress="return isNumberKey(this, event);"  required />
                            <span class="glyphicon glyphicon-usd form-control-feedback"></span>
