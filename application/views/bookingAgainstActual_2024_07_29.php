                ...
                <div class="col-lg-12 col-xs-12">
                    ...
                    if (!empty($DailySales) && isset($DailySales)) {
                        ...
                        for ($n = 1; $n <= date('t', strtotime($datepickermonth)); $n++) {
                            ...
                            $strDayColWithPC .= '<th class="fix" colspan="3">' . $monthName . '-' . sprintf("%02d", $n) . '</th>';
                            $strDayColValPC .= '<th>' . sprintf("%02d", $n) . ' B-Value</th><th>' . sprintf("%02d", $n) . ' A-Value</th><th style="background: #efebb9;">' . sprintf("%02d", $n) . ' PC</th>';
                        }
                        //echo $strDayCol;
                        $strBack = '';
                        for ($k = 1; $k <= 6; $k++) {
...
if (!empty($DailySalesQty) && isset($DailySalesQty)) {
                        ...
                        for ($n = 1; $n <= date('t', strtotime($datepickermonth)); $n++) {
                            $strDayCol .= '<th>' . $monthName . '-' . sprintf("%02d", $n) . '</th>';
                            $strDayColWithPC .= '<th class="fix" colspan="3">' . $monthName . '-' . sprintf("%02d", $n) . '</th>';
                            $strDayColValPC .= '<th>' . sprintf("%02d", $n) . ' B Qty</th><th>' . sprintf("%02d", $n) . '  A Qty</th><th style="background: #efebb9;">' . sprintf("%02d", $n) . ' PC</th>';
                        }
                        //echo $strDayCol;
                        $strBack = '';
                        for ($k = 1; $k <= 6; $k++) {
