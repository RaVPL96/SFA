    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <form class="form-horizontal" id="OrderData" action="<?= base_url('icstockcontrolreports/getShipmentsData') ?>" method="post">
						<label class="col-md-12 label label-default"> - පිටත් කරන ලද අයිතම  වාර්ථාව - </label>
						<label class="col-md-12 label label-default"> - I/C Stock Control Shipments Detail Report - Report - </label>
...
<script type="text/javascript">
								...
								$('#OrderData').validate({
									...
									submitHandler: function(form) {
										...
										$.ajax({											
											url: '<?=base_url('icstockcontrolreports/getShipmentsData')?>',
											type: 'POST',
											data: $(form).serialize(),
