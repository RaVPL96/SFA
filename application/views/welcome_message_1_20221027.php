        ...
        <div class="row">
            <div class="col-md-12 ">
                <h4 class="text-info">
                    ...
                    <div class="col-md-11"><marquee  style="color: #b90638;">Area target updated including not operating territory targets.<br>ක්‍රියාත්මක නොවන විකුණුම් නියෝජිතායතන ඉලක්ක ඇතුළුව ප්‍රදේශ ඉලක්කය යාවත්කාලීන කරන ලදී</marquee></div>
                </h4>
            </div>
                                    ...
                                    <div class="box box-widget widget-user">
                                        <div class="small-box bg-green">
                                            <div class="inner">
                                                ...
                                                <h3>' . $percent . '<sup style="font-size: 20px">%</sup><sub style="font-size: 18px">Achieved so far from Rs. ' . number_format($totTargetA) . '</sub></h3>
                                            </div>
                                            <div class="icon">
                                                <i class="ion ion-stats-bars"></i>
                                            </div>
