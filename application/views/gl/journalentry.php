                ...
                <div class="col-md-12">
                    <form class="form-horizontal" id="OrderData" action="<?= base_url('orderentryreports/generateItemOrdDetail') ?>" method="post">
                        <div class="form-group">
							<label class="col-md-12 label label-default"> - පොදු ලෙජරයේ සටහන් ජර්නල් සටහන් වාර්ථාව </label>
							<label class="col-md-12 label label-default"> - G/L Journal Entry Report</label>
