...
<div class="content-wrapper">
    ...
    <section class="content" style="overflow:hidden;">
        <div class="row">
            ...
            <div class="col-lg-4 col-xs-12">
                <div class="small-box bg-red">
                    ...
                    <a href="<?= base_url('welcome/homeReport') ?>" class="small-box-footer">Click here <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">  
                <form class="form-horizontal" id="myForm" action="<?= base_url('bookingSale/homeReport') ?>" method="post">
                     <?php 
        ...
        <div class="col-md-12" style="overflow-x: scroll; overflow-y: scroll; max-height: 700px;">
            <div class="row">
                <h2>Android App Booking Report</h2>
...
//PRINT AREA TOTAL AT THE END
    ...
    ?>
                        ...
                        <div class="box-body chart-responsive">
                            <div class="chart" id="line-chart" style="height: 300px;display: none;"></div>
                        </div>
