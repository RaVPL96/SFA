                ...
                <div class="col-md-12">
                    <form class="form-horizontal" id="OrderData" action="<?= base_url('orderentryreports/generateItemOrdDetail') ?>" method="post">
                        <div class="form-group">
							<label class="col-md-12 label label-default"> - ඉන්වොයිසි සදහා අදාල මුදල් ගෙවුම් පිළිබද වාර්ථාව  </label>
							<label class="col-md-12 label label-default"> - Invoice Related Payment Receipt Report</label>
							...
							function setTextField(ddl) {
								...
								$('#OrderData').validate({
									...
									submitHandler: function(form) {
										...
										$.ajax({											
											url: '<?=base_url('artransaction/generateInvoicePaymentRpt')?>',
											type: 'POST',
											data: $(form).serialize(),
