...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <form action="<?= base_url('welcome/sales') ?>" method="post" class="form-horizontal">
                    <div class="col-md-4">
                        ...
                        <select name="channelID" class="form-control">
                            ...
                            if (!empty($ChannelList) && isset($ChannelList)) {
                                foreach ($ChannelList as $value) {
                                    //echo $value['id'] ;
                                    echo '<option value="' . $value['id'] . '">' . $value['channel_name'] . '</option>';
                                }
                                //print_r($ChannelList);
                            }
                            ?>
        ...
        <div class="row">
            <div class="col-md-12 " style="display: none;">
                <h4 class="text-info">
                    ...
                    <div class="col-md-3"><a target="_blank" class="btn btn-danger" href="https://docs.google.com/spreadsheets/d/1xVJNxnBRzEUr-qdjx-CIL1lEQ3WA5x25/edit?usp=share_link&ouid=115829541913021206368&rtpof=true&sd=true">C Range - Check Agency GPS Locations</a></div>
                    <div class="col-md-8"><marquee  style="color: #e3d4d8;background: #7a02b7;padding: 5px;">C Range - Check current agency locations sent by ASE</marquee></div>
                </h4>
                <div class="clearfix"></div>
                <h4 class="text-info">
                    <div class="col-md-1"><img src="https://icon-library.com/images/new-icon-gif/new-icon-gif-13.jpg" style="width: 80px;height: auto;"></div>
                    <div class="col-md-3"><a target="_blank" class="btn btn-success" href="https://docs.google.com/spreadsheets/d/11jqGpvuyggVl_QGgGc_TB6MZ4-WpLbr_/edit?usp=share_link&ouid=115829541913021206368&rtpof=true&sd=true">D Range - Check Agency GPS Locations</a></div>
                    <div class="col-md-8"><marquee  style="color: #e3d4d8;background: #7a02b7;padding: 5px;">D Range - Check current agency locations sent by ASE</marquee></div>
                </h4>
                <!--
                <h4 class="text-info">
                    <div class="col-md-1"><img src="https://icon-library.com/images/new-icon-gif/new-icon-gif-13.jpg" style="width: 80px;height: auto;"></div>
                    <div class="col-md-11"><marquee  style="color: #e3d4d8;background: #7a02b7;padding: 5px;">Now you can check Rata Savari and Insurance Scheme Target and status . Visit "Customer Module" -> "Promotion Status".<br> දැන් ඔබට රට සවාරි සහ රක්ෂණ යෝජනා ක්‍රමයේ ඉලක්කය සහ තත්ත්වය පරීක්ෂා කළ හැක. Visit :"Customer Module" -> "Promotion Status" </marquee></div>
                </h4>
                <h4 class="text-info">
                    <div class="col-md-1"><img src="https://icon-library.com/images/new-icon-gif/new-icon-gif-13.jpg" style="width: 80px;height: auto;"></div>
                    <div class="col-md-11"><marquee  style="color: #e3d4d8;background: #ff0202;padding: 5px;">ASE/ASM Approval for Sales rep outlet update is now ready. Visit "Customer Module" -> "Outlet Update" and approve updated shops details.<br>අලෙවි නියෝජිත මහතුන්ගේ අලෙවිසැල් විස්තර යාවත්කාලීන කිරීම සඳහා ASE/ASM අනුමැතිය දැන් සූදානම්. "Customer Module" -> "Update Outlet" වෙත ගොස් යාවත්කාලීන කරන ලද වෙළඳසැල් විස්තර අනුමත කරන්න</marquee></div>
                </h4>
                -->
            </div>
            <div class="clearfix"></div>
            ...
            if (!empty($SalesData) && isset($SalesData)) {//this is for ase
                        ...
                        if (!empty($targetData) && isset($targetData)) {
                            foreach ($targetData as $t) {
                                if ($t['ag_cd'] == $territory_reference_code) {
                                    ...
                                    array_push($territory_list_array, $t['ag_cd']);
                                }
                            }
                        }
                                ...
                                . '<div class="col-md-6">
                                    <div class="box box-widget widget-user">
                                        <div class="small-box bg-green">
                                            <div class="inner">
                                                <h3>' . $strTerritory . '</h3>
                                                <h3>' . $percent . '<sup style="font-size: 20px">%</sup><sub style="font-size: 18px">Achieved</sub> / Rs. ' . number_format($target) . ' <sub style="font-size: 18px">Target</sub> / Rs. ' . number_format($totTerrAValue) . ' Actual</h3>
                                            </div>
                                            <div class="icon">
                                                <i class="ion ion-stats-bars">a</i>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="row">
                                            ...
                                            <a target="_blank" href="' . base_url('salesreports/areaSummery/null/' . $strArea_id . '/' . $strRange_id . '/' . $strTerritory_id . '/' . str_replace(' ', '', $dt) . '/A/null/' . $channelID) . '" class="small-box-footer">
                            ...
                            $chartData .= ''
                                    ...
                                    <div class="box box-widget widget-user">
                                        <div class="small-box bg-green">
                                            <div class="inner">
                                                <h3>' . $strTerritory . '</h3>
                                                <h3>' . $percent . '<sup style="font-size: 20px">%</sup><sub style="font-size: 18px">Achieved</sub> / Rs. ' . number_format($target) . ' <sub style="font-size: 18px">Target</sub> / Rs. ' . number_format($totTerrAValue) . ' <sub style="font-size: 18px">Actual</sub></h3>
                                            </div>
                                            <div class="icon">
                                            ...
                                            <a target="_blank" href="' . base_url('salesreports/areaSummery/null/' . $strArea_id . '/' . $strRange_id . '/' . $strTerritory_id . '/' . $dt . '/A/null/' . $channelID) . '" class="small-box-footer">
                                                More info <i class="fa fa-arrow-circle-right"></i>
                                            </a>
                                        </div>
                                    </div>
                ...
                $totTargetValue = 0;
                //DISPLAY TERRITORYS NOT OPERATING
                foreach ($targetData as $target) {
                    $totTargetA = $target[strtolower($strRangeName) . '_target'];
                    $totTargetValue = $totTargetValue + $totTargetA;
                    if ($totTargetA != 0 && !in_array($target['ag_cd'], $territory_list_array)) {//IF NOT IN ARRAY CREATE A EMPTY SUMMERY LINE WITH 0 TARGET SUMMERY
                        $percent = number_format((0 / $totTargetA) * 100);
                        $chartData .= ''
                                . '<div class="col-md-6">
                                    <div class="box box-widget widget-user">
                                        <div class="small-box bg-green">
                                            <div class="inner">
                                                <h3>' . $target['ag_name'] . '</h3>
                                                <h3>' . $percent . '<sup style="font-size: 20px">%</sup><sub style="font-size: 18px">Achieved</sub> / Rs. ' . number_format($totTargetA) . ' <sub style="font-size: 18px">Target</sub> / </h3>
                                            </div>
                                            <div class="icon">
                                                <i class="ion ion-stats-bars"></i>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-sm-4 border-right">
                                                        <div class="description-block">
                                                            <h5 class="description-header">Rs. ' . number_format(0) . '<br>(' . number_format((0) * 100, 1) . ' %)</h5>
                                                            <span class="description-text">ACTUAL SALES</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="description-block">
                                                            <h5 class="description-header">Rs. ' . number_format((0 + 0)) . '<br>(' . number_format((0) * 100, 1) . '%)</h5>
                                                            <span class="description-text">Return Value</span>
                                                        </div>
                        ...
                        . '<div class="col-md-12">
                                    <div class="box box-widget widget-user">
                                        <div class="small-box bg-navy">
                                            <div class="inner">
                                                <h3>Summery</h3>
                                                <h3>' . number_format(($totAValue / $totTargetValue) * 100) . '<sup style="font-size: 20px">%</sup><sub style="font-size: 18px">Achieved so far from Rs. ' . number_format($totTargetValue) . '</sub></h3>
                                            </div>
                                            <div class="icon">
                                                <i class="ion ion-stats-bars"></i>
                                            </div>
                                            ...
                                            <a target="_blank" href="' . base_url('salesreports/areaSummery/null/' . $strArea_id . '/' . $strRange_id . '/null/' . str_replace(' ', '', $dt) . '/A/null/' . $channelID) . '" class="small-box-footer">
                                                More info <i class="fa fa-arrow-circle-right"></i>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                foreach ($SalesData_Area_Summery as $s) {
                                        ...
                                        if (!empty($targetData) && isset($targetData)) {
                                            foreach ($targetData as $t) {
                                                if ($t['area_cd'] == $area_code) {
                                                    ...
                                                    $st = $st.$t['ag_name'].'-'.$s['range_name'].'-'.$t[strtolower($s['range_name']) . '_target'].'<br>';
                                                }
                                            }
                                        }
                                        $percentA = '-';
                                    ...
                                    <div class="box box-widget widget-user">
                                        <div class="small-box bg-blue">
                                            <div class="inner">
                                                <h3>' . $strArea . '</h3>
                                                <h3>' . $percentA . '<sup style="font-size: 20px">%</sup><sub style="font-size: 18px">Achieved so far from Rs. ' . number_format($targetA) .''/*$st*/. '</sub></h3>
                                            </div>
                                            <div class="icon">
                                                <i class="ion ion-stats-bars"></i>
                                            </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="description-block">
                                                            <!-- <h5 class="description-header">Rs. ' . number_format(($totAreaMValue + $totAreaGValue)) . '<br>(' . number_format((($totAreaMValue + $totAreaGValue) / $totAreaAValue) * 100) . '%)</h5> -->
                                                                <h5 class="description-header">Rs. ' . number_format($totAreaMValue) . ' (' . number_format((($totAreaMValue) / $totAreaAValue) * 100, 2) . '% MR)<br>Rs. ' . number_format($totAreaGValue) . ' (' . number_format((($totAreaGValue) / $totAreaAValue) * 100, 2) . '% GR)</h5>
                                                            <span class="description-text">Return Value</span>
                                                        </div>
                                            ...
                                            <a target="_blank" href="' . base_url('salesreports/areaSummery/null/' . $area_code . '/' . $s['range_id'] . '/null/' . str_replace(' ', '', $dt) . '/A/null/' . $channelID) . '" class="small-box-footer">
                                                More info <i class="fa fa-arrow-circle-right"></i>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="box box-widget widget-user">
                                        <div class="small-box bg-navy">
                                            <div class="inner">
                                                ...
                                                <div style="font-size: 38px;font-weight: bold;">' . $achivePercent . '<sup style="font-size: 20px">%</sup><sub style="font-size: 18px">Achieved</sub> / Rs. ' . number_format($range_totTarget) . ' <sub style="font-size: 18px">Target</sub> / Rs. ' . number_format($range_totAValue) . ' <sub style="font-size: 18px">Actual</sub></div>
                                            </div>
                                            <div class="icon">
                                                <i class="ion ion-stats-bars"></i>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4 border-right">
                                                        <div class="description-block">
                                                            ...
                                                            <span class="description-text">ACTUAL SALES FROM BOOKINGS</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="description-block">
                                                            <!-- <h5 class="description-header">Rs. ' . number_format(($range_totMValue + $range_totGValue)) . '<br>(' . number_format((($range_totMValue + $range_totGValue) / $range_totAValue) * 100) . '%)</h5> -->
                                                                <h5 class="description-header">Rs. ' . number_format($range_totMValue) . ' (' . number_format((($range_totMValue) / $range_totAValue) * 100, 2) . '% MR)<br>Rs. ' . number_format($range_totGValue) . ' (' . number_format((($range_totGValue) / $range_totAValue) * 100, 2) . '% GR)</h5>
                                                            <span class="description-text">Return Value Status</span>
                                                        </div>
            ...
            ' . $areaChartData . '
                    ...
                    if (!empty($ChannelMapping) && isset($ChannelMapping)) {
                        foreach ($ChannelMapping as $c) {
                            ...
                            for ($i = $beginDt; $i <= $endDt; $i = date('Y-m-d', strtotime($i . ' +1 day'))) {
                                foreach ($RangeList as $r) {
                                    if ($r['range_id'] != 5) {//Skip town operation
                                        $range_totAValue = 0;
                                        $SalesData_Area_Summery = ${'SalesData_Area_Summery_' . $c['channel_id'] . '_' . $r['range_id']};
                                        if (!empty($SalesData_Area_Summery) && isset($SalesData_Area_Summery)) {
                                            $strArea = '';
