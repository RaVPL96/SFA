    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <form class="form-horizontal" id="OrderData" action="<?= base_url('orderentryreports/getNotInvoicedData') ?>" method="post">
						<label class="col-md-12 label label-default"> - බිල් නොකරන ලද සක්‍රීය ඇනවුම්  වාර්ථාව - </label>
						<label class="col-md-12 label label-default"> - Sales Orders Not yet Invoiced - Report - </label>
...
<script type="text/javascript">
								...
								$('#OrderData').validate({
									...
									submitHandler: function(form) {
										...
										$.ajax({											
											url: '<?=base_url('orderentryreports/getNotInvoicedData')?>',
											type: 'POST',
											data: $(form).serialize(),
