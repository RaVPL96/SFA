    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <form class="form-horizontal" id="OrderData" action="<?= base_url('orderentryreports/genErpSalesHistoryData') ?>" method="post">
						<label class="col-md-12 label label-default"> - අතීත විකුණුම්  වාර්ථාව - </label>
						<label class="col-md-12 label label-default"> - Sales Orders History - Report - </label>
...
<script type="text/javascript">
								...
								$('#OrderData').validate({
									...
									submitHandler: function(form) {
										...
										$.ajax({											
											url: '<?=base_url('orderentryreports/genErpSalesHistoryData')?>',
											type: 'POST',
											data: $(form).serialize(),
