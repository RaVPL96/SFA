...
// 
    ...
    $('#aaareaID').on('change', function () {
        $('#RangeRep').val(-1);
        $('#sbTerritory').empty();
        $('#RangeRepStock').val(-1);
    });
    $('#RangeRep').on('change', function () {
        $('#uploading').modal('show');
        $('#sbTerritory').empty();
        $('#sbRangeRep').val(-1);
        $('#sbRep').empty();
        ...
        $.ajax({
            type: 'get',
            url: "<?= base_url('master/getTerritoryListAjaxNewDemarcation') ?>",
            data: {
                areaid: $('#aaareaID').val(),
                rangeid: selectVal
            },
    ...
    $('#areaIDStock').on('change', function () {
        $('#uploading').modal('show');
        $('#sbTerritory').empty();
        $('#sbRangeRep').val(-1);
        $('#sbRep').empty();
        ...
        $.ajax({
            type: 'get',
            url: "<?= base_url('master/getTerritoryListAjaxCommon') ?>",
            data: {
                areaid: selectVal
            },
            success: function (data) {
     ...
     $('#RangeRepStock').on('change', function () {
        $('#uploading').modal('show');
        $('#sbTerritory').empty(); 
        var selectVal = $(this).val();
        $.ajax({
