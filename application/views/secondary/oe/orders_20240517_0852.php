            ...
            <div class="col-md-12">
                ...
                <div class="col-md-12">
					...
					<div class="col-md-6">
						...
						<div class="col-md-12">
                        <div class="form-group">
                            <input type="submit" class="btn btn-danger" name="submit" value="Get Stock">
                        </div>                                
                    </div>
								</form>
								<div class="col-md-6">
                            ...
                            <table class="table table-bordered table-hover" style="overflow-x: scroll;clear:both;width: 1300px; ">
                                ...
                                ?>
                                    <tr id="line1">
										...
										<td class="col-md-3"><input class="form-control text-center" type="text" name="estimatepartpriceUnit[]" id="estimatepartpriceUnit1" value="" readonly="readonly" style="width: 58px;"></td>
										<td class="col-md-3"><div class="col-md-12"><input class="form-control text-right" name="estimatepartqty[]" id="estimatepartqty1" onkeyup="setSubTot(1)" type="text" ></div></td>
										<td class="col-md-3"><div class="col-md-12"><input class="form-control text-right" name="estimatedamageqty[]" id="estimatedamageqty1" onkeyup="setSubTot(1)" type="text" ></div></td>
										<td class="col-md-3"><input class="form-control text-right" type="text" name="estimatepartprice[]" id="estimatepartprice1" value="0.00" readonly="readonly" style="width: 89px;"></td>
								...
								<tr style="background-color: #b6ead6;">
									...
									<td class=""><input type="checkbox" name="estimateline" id="estimate1" value="line1"><input type="hidden" name="rowid[]" id="rowid" value="1"></td>
												...
												<td><input class="text-right" type="text" id="sellableQty<?php echo $x; ?>" name="sellableQty<?php echo $x; ?>" onkeyup="checkSubTot(<?php echo $x; ?>);"/></td>
												<td><input class="text-right" type="text" id="damageQty<?php echo $x; ?>" name="damageQty<?php echo $x; ?>" onkeyup="checkSubTot(<?php echo $x; ?>);"/></td>
												<td style="text-align:right"><input class="text-right" type="text" value="<?php echo $items['unit_price'] ?>" readonly id="unitPrice<?php echo $x; ?>" name="unitPrice<?php echo $x; ?>"/></td>
												<!-- <td><input type="text"/></td> -->
												<td><input class="text-right" type="text" id="subTotal<?php echo $x; ?>" name="subTotal<?php echo $x; ?>"/></td>
											</tr>
										<?php
									$x++;
									}
...
<script type="text/javascript">
	...
	function checkSubTot(id){
		var qty = document.getElementById('sellableQty'+id).value;
		var dam = document.getElementById('damageQty'+id).value;
		var price = document.getElementById('unitPrice'+id).value;
	...
	function setSubTot(id){
		...
		var qty = document.getElementById('estimatepartqty'+id).value;
		var dam = document.getElementById('estimatedamageqty'+id).value;
		var price = document.getElementById('estimatepartprice'+id).value;
