                ...
                <div class="col-md-5">
					...
					<form class="form-horizontal" id="OrderData" action="<?= base_url('salesoetransaction/SaveOrderentry') ?>" method="post">		
						...
						<label class="col-md-4">Customer <span class="text-red">*</span></label>
							<div class="col-md-8">
								<select id="customerID" name="customerID" class="form-control selectpicker" data-show-subtext="true" data-live-search="true"  onchange="setTextField(this)">
									<?php									
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<div class="input-group">
									...
									<input type="text" name="requestDate" class="form-control pull-right" readonly id="datepicker"/>
								</div><!-- /.input group -->
							</div><!-- /.form group -->	
						</div>
						<div class="form-group">
							<label class="col-md-4">Amount <span class="text-red">*</span></label>
							<div class="col-md-8">
								<div class="input-group">
									<div class="input-group-addon">
										Rs.
									</div>
									<input type="text" name="amount" class="form-control pull-right" id="amount"/>
								</div><!-- /.input group -->
							</div><!-- /.form group -->	
						</div>
						<div class="form-group">
