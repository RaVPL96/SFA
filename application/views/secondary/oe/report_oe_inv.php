...
<div class="content-wrapper">    <!-- Content Header (Page header) -->    
    <section class="content-header">       
        <h1>            Secondary Sales O/E Transactions            <small>Review O/E Transactions </small>        </h1>  
        <ol class="breadcrumb">       
        ...
        <div class="row">            
            <div class="col-md-12">               
                ...
                <div class="row" style="overflow-x: scroll;">   
                    <div class="col-md-12">                 
                        <form class="form-horizontal" id="OrderData" action="<?= base_url('Salesoetransaction/invoiceReport') ?>" method="post" novalidate="novalidate">             
                            <div class="col-md-6">       
                    ...
                    if (!empty($ordersH) && isset($ordersH)) {
                        ...
                        foreach ($ordersH as $h) {
                            ...
                            $rows = $rows . '<tr onclick="view_invoice(\'' . $h['app_inv_no'] . '\')" style="cursor: pointer;">'
                                    ...
                                    . '<td>' . $h['address2'] . '</td>.'
                                    . '<td>' . $h['address3'] . '</td>'
                                    . '<td>' . $h['contact_person'] . '</td>									<td>' . $h['mobile'] . '</td>									<td>' . $h['subtotal'] . '</td>								'
                                    ...
                                    . '<td>' . intval(abs(strtotime($h['inv_date'] . ' ' . $h['inv_start_time']) - $oldtime) / 60) . '</td>'
                                    . '<td>' . $h['audit_user'] . '</td>'
                                    . '</tr>';
                            $oldtime = strtotime($h['inv_date'] . ' ' . $h['inv_time']);
                            $gps[$billcount] = array(
                        ...
                        <table id="table-area" class="table table-hover">        
                            <thead>   
                                ...
                                <tr>			
                                    ...
                                    <th>Traval Time(with last bill point) (Min)</th>      
                                    <th>Audit User</th>                         
                                </tr>                         
                            </thead>  
                            <tbody>                               
