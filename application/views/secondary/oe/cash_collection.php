...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Secondary Sales Cash Collections
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-7">
                        <form class="form-horizontal" id="" action="<?= base_url('salesoetransaction/addCollections') ?>" method="post">
						<div class="form-group">
							<label class="col-md-12 label label-default"> - මුදල් ලැබීම් - </label>
							<label class="col-md-12 label label-default"> - Cash Collections - </label>
						...
						<br>
								...
								<div class="box">
								<div class="box-body">
								<h3>Invoices with Pending Payments</h3>
