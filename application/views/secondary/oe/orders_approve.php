...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Secondary Sales Order Entry Approval
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-7">
                        <form class="form-horizontal" id="" action="<?= base_url('salesoetransaction/Orderapprove') ?>" method="post">
						<div class="form-group">
							<label class="col-md-12 label label-default"> - ඇණවුම් ඉල්ලීම් අනුමත කිරීම්</label>
							<label class="col-md-12 label label-default"> - Order Approvals</label>
					...
					<form class="form-horizontal" id="OrderData" action="<?= base_url('salesoetransaction/ApproveOrderentry') ?>" method="post">
						<?php
						$cusid='';
						$orderdate='';
						$amount='';
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<div class="input-group">
									...
									<input type="text" name="approveamount" class="form-control pull-right" id="approveamount" value="<?=$amount?>"/>
								</div><!-- /.input group -->
							</div><!-- /.form group -->	
						</div>
						<div class="form-group">
							<label class="col-md-4">Action<span class="text-red">*</span></label>
							<div class="col-md-8">
								<label class="label label-success col-md-4"><input class="col-md-1" type="radio" name="approve" value="1"/> Approve</label>
								<div class="clearfix"></div>
								<label class="label label-danger col-md-4"><input class="col-md-1" type="radio" name="approve" value="2"/> Reject</label>
							</div><!-- /.form group -->	
						</div>
						<div class="form-group">
							...
							<button type="submit" value="2" name="GenerateReport" class="btn btn-sm btn-success float-right"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Update Status</button>
							</div>
                        </div>
...
<table id="example1" class="table table-hover">
	...
	<tbody>
		...
		<tr>
			...
			<td><a class="link link-success" href="<?=base_url('salesoetransaction/Orderapprove/'.$ord['id'])?>">Update</a></td>
		</tr>
		<?php } ?>
	</tbody>
</table>						
