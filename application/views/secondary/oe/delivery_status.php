...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Secondary Sales Delivery Status
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-7">
                        <form class="form-horizontal" id="" action="<?= base_url('salesoetransaction/DeliveryStatus') ?>" method="post">
						<div class="form-group">
							<label class="col-md-12 label label-default"> - ඉන්වොයිස් ප්‍රවාහන සහ මුදල් එකතු කර ගැනීම් - </label>
							<label class="col-md-12 label label-default"> - Invoice Delivery and Cash Collections - </label>
						...
						<br>
								...
								<div class="box">
								<div class="box-body">
								<h3>Invoices in Pending Delivery</h3>
...
<table id="example1" class="table table-hover">
	...
	<tbody>
		...
		<tr>
			...
			<td><a class="link link-success" href="<?=base_url('salesoetransaction/DeliveryStatus/'.$ord['id'])?>">Invoice</a></td>
		</tr>
		<?php } ?>
	</tbody>
</table>						
				...
				<div class="col-md-12" id="">
					<form class="form-horizontal" id="OrderData" action="<?= base_url('salesoetransaction/saveInvoice') ?>" method="post">
						...
						$invDate='';
						$invoiceid='new';
						if(!empty($InvoiceData) && isset($InvoiceData)){
							$orderID=$InvoiceData->id;
							$cusid=$InvoiceData->customer_id;
							$orderdate=$InvoiceData->order_date;
							$amount=$InvoiceData->net_amount;
							$apprveamount=$InvoiceData->approved_amount;
							$oplid=$InvoiceData->channel_id;
							$sopaid=$InvoiceData->area_id;
							$territoryid=$InvoiceData->territory_id;
							$routeid=$InvoiceData->route_id;
							$ERPinvNum=$InvoiceData->erp_inv_number;
							$invTotal=$InvoiceData->inv_amount;
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" readonly name="ErpInvNum" class="form-control pull-right" id="ErpInvNum" value="<?=$ERPinvNum?>"/>
							</div><!-- /.form group -->	
						</div>
						<div class="form-group">
							...
							<div class="col-md-8">
								<div class="input-group">
									...
									<input type="text" readonly name="InvDate" class="form-control pull-right" id="" value="<?=$invDate?>"/>
								</div><!-- /.input group -->
							</div><!-- /.form group -->	
						</div>
						<div class="form-group">
							...
							<div class="col-md-8">
								<div class="input-group">
									...
									<input type="text" readonly name="InvAmount" class="form-control pull-right" id="InvAmount" value="<?=$invTotal?>"/>
								</div>
							</div><!-- /.form group -->	
						</div>
						<div class="form-group">
							<label class="col-md-4">Invoice Delivered<span class="text-red">*</span></label>
							<div class="col-md-8">
						...
						<div class="box-header ">
							<div class="form-group">
								<label class="col-md-4">Cheque Collected<span class="text-red">*</span></label>
								<div class="col-md-8">
									<select class="form-control">
										<option>Yes</option>
										<option>No</option>
							...
							<div class="form-group">
								<label class="col-md-4">Cheque Date<span class="text-red">*</span></label>
								<div class="col-md-8">
									<div class="input-group">
										<div class="input-group-addon">
											<i class="fa fa-calendar"></i>
										</div>
										<input type="text" name="InvDate" class="form-control pull-right" id="datepicker" value=""/>
									</div><!-- /.input group -->
								</div><!-- /.form group -->	
							</div>
							<div class="form-group">
								<label class="col-md-4">Cheque Amount<span class="text-red">*</span></label>
								<div class="col-md-8">
									<div class="input-group">
										<div class="input-group-addon">
											Rs.
										</div>
										<input type="text" name="InvDate" class="form-control pull-right" id="" value=""/>
									</div><!-- /.input group -->
								</div><!-- /.form group -->	
							</div>
						</div>
						...
						<div id="newChequeEntry"></div>
						<div class="form-group">	
							<button type="submit" onclick="addChequeEntry();return false;" value="2" name="GenerateReport" class="btn btn-sm btn-success float-right"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Add New Cheque Data</button>
						</div>
						<div class="form-group">						
							<div class="col-md-12">
							...
							<button type="submit" value="2" name="GenerateReport" class="btn btn-sm btn-success float-right"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Update Delivery/Cash Collections</button>
							</div>
                        </div>
...
function addChequeEntry(){
	$('#newChequeEntry').append($('#chequeEntry').html());
}
