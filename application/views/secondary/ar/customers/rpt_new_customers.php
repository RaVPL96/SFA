                ...
                <form class="form-horizontal" id="" action="<?= base_url('salesarcustomers/newCustomerReport') ?>" method="post">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select id="rpt_type" name="rpt_type" class="form-control">
                                    <?php
                                    $strS = '';
                                    $strR = '';
                                    if ($rpt_type == 'territory_wise') {
                                        $strS = ' selected ';
                                    }
                                    ...
                                    ?>
                                    <option <?= $strS ?> value="territory_wise">New Shops Territory-wise</option>     
                                    <option <?= $strR ?> value="route_wise">New Shops Territory-Route-wise</option>     
                                </select>
                            </div>
                        </div>                            
                    </div>
                    ...
                    <table id="table-area" class="table table-hover">	
                        <thead>						
                            <tr>	
                                ...
                                ?>
                                <th>Total New Shops (within period)</th>
            <!-- <th>Image</th> 	-->	
                            </tr>		
                        </thead>		
                        <tbody>			
                            <?php foreach ($outlets as $o) {
                                ...
                                <tr>		
                                    ...
                                    do {
                                        ...
                                        if ($rpt_type == 'route_wise') {
                                            foreach ($outletsDetails as $a) {
                                                if ($o['area_name'] == $a['area_name'] && $o['territory_name'] == $a['territory_name'] && $o['route_name'] == $a['route_name']) {
                                    ...
                                    $created_by_text_new = '<small class="text-muted">';
                                    if ($rpt_type == 'route_wise') {
                                        foreach ($outletsDetails as $a) {
                                            if ($o['area_name'] == $a['area_name'] && $o['territory_name'] == $a['territory_name'] && $o['route_name'] == $a['route_name']) {
                                                $created_by_text_new .= '<br>' . $a['created_by'] . '-' . $a['rep_new_total'];
                                            }
                                        }
                                    } else {
                                        foreach ($outletsDetails as $a) {
                                    ...
                                    $created_by_text_new .= '</small>';
                                    ?>
                                    <td><?= $o['Total New Shops'] . $created_by_text_new ?></td>
                                </tr>						
                                <?php
                            }
                            ?>                    			
