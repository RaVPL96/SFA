...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Shop List 
            <small>Shop List Agency Wise </small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12" style="overflow-x: scroll;">
                ...
                <form class="form-horizontal" id="" action="<?= base_url('salesarcustomers/shopList') ?>" method="post">
                    <div class="col-md-6">                            
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <input type="submit" class="btn btn-danger" name="submit" value="Get Report">
                             <input type="button" class="btn btn-success" id="excel" name="excel" onclick="ExportExcel('shop_list', 'Shop_List_<?= $DateRange ?>')" value="Download Excel">
                        </div>                                
                    </div>
    ...
    <!-- <th>Reference Code</th> -->
                        ...
                        <tbody>			
                            ...
                            foreach ($outlets as $o) {
                                ...
                                ?>
                                <tr>		
                                    <td><?= $o['territory_reference_code'] . '/' . sprintf('%02d', $o['route_reference_code']) . '/' . sprintf('%03d', $o['outlet_code']) ?></a></td> 
