        ...
        <div class="row">
            <div class="col-md-12" style="overflow-x: scroll;">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-6"><?php if($image_created==1){ ?><img style="width:450px;" src="<?=base_url('../dbbackup/images/'.$image_name)  ?>"/><?php }else{ ?><img style="width:450px;" src="data:image/jpeg;base64,<?= $image ?>"/><?php } ?></div>
                </div>
                <div class="col-md-12">
