...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Secondary Sales HR Module - GPS Tracking
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12" style="overflow-x: scroll;">
                <h4>GPS data only works till 5:30PM every day only. GPS දත්ත සෑම දිනකම සවස 5:30 දක්වා පමණක් ක්‍රියා කරයි</h4>
                ...
                <form class="form-horizontal" id="" action="<?= base_url('hr/timeAttendance') ?>" method="post">
                    ...
                    <div class="col-md-3">             
                        <div class="form-group">         
                            ...
                            <div class="col-md-12">                                        
                                <select id="sbRangeRep" name="rangeID" class="form-control">
                    ...
                    <div class="col-md-3">    
                        <div class="form-group">      
                            ...
                            <div class="col-md-12">                                     
                                <select id="sbRep" name="repID" class="form-control">  
                                    <option value=""> -- Select Sales Rep -- </option>     
                                    <?php
                                    if (!empty($srep) && isset($srep)) {
                                        foreach ($srep as $t) {
                                            $select = '';
                                            if (!empty($sRepID) && isset($sRepID) && $sRepID == $t['territory_id']) {
                                                $select = 'selected';
                                            } echo '<option ' . $select . ' value="' . $t['territory_id'] . '"> ' . $t['territory_name'] . '</option>';
                                        }
                                    }
                    ...
                    <div class="col-md-3">    
                        <div class="form-group">      
                            <label class="col-md-12">From Time<span class="text-red">*</span></label>
                            <div class="col-md-12">                                     
                                <select id="sbFrom" name="fromID" class="form-control">  
                    ...
                    <div class="col-md-3">    
                        <div class="form-group">      
                            <label class="col-md-12">To Time<span class="text-red">*</span></label>
                            <div class="col-md-12">                                     
                                <select id="sbTo" name="ToID" class="form-control">  
                    ...
                    <div class="col-md-3">
                        <div class="form-group">  
                            ...
                            <input type="range" id="car_range" name="car_range" max="20" min="1" value="5">
                            <input type="button" class="btn btn-success" onclick="draw_live_route(); return false;" value="Draw Path"/>
                            <input type="button" class="btn btn-default" onclick="Load_Map2(); return false;" value="Clear"/>
                            <span id="Pause"><input type="image" onclick="kzonec33(); return false;" id="PauseBtn" src='<?= base_url('adminlte/dist/img/gps/pause.png'); ?>'  /></span> 
                            <span id="Resume"><input type="image" onclick="kzonec44(); return false;" id="ResumeBtn" src='<?= base_url('adminlte/dist/img/gps/play.png'); ?>' /></span> 

                        </div>
                    </div>
                </form>
                <div class="col-md-12">
                    <div id="routes" style="height:500px">

                    </div>
                    <div style="float: right;z-index: 1;position: absolute;bottom: 50px;
                         right: 80px;">
                        <!--<input id="myValues" />-->
                        <span id="km_ly" style=";
                              top: -55px;
                    ...
                    <div id="win" style="font-weight: bold;font-size:20px;color: black">

                    </div>
                    <div id="div_view_session" style="color: #6F6F6F; font-weight: 400; display: none;">
                        <h4>Facility is under development and will be available soon.  පහසුකම් සංවර්ධනය වෙමින් පවතින අතර ඉක්මනින් ලබා ගත හැකිය</h4>
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input onmouseover="setDate(this.id);" id="invdate" name="invdate" value="<?= date('Y-m-d'); ?>">
                                                            <!--<input type="date" style="width: 150px" placeholder="Date" id="invdate" name="invdate" >-->

                                                        </td>
                                                        <td>
                                                            <input type="hidden" id="invzoneCount" name="invzoneCount" value="0">
                                                            <label>District: </label>
                                                        </td>
                                                        <td>
                                                            <select style="width: 140px" id="invarea_outlet" onchange="getTeritoryinv();">
                                                                <option id="invarea_0" value="0">Select District</option>
                                                            </select>
                                                        </td>
                                                        <td>&nbsp;&nbsp;</td>

                                                        <td id="invteritory_label">
                                                            <label>Agency Area: </label>
                                                        </td>
                                                        <td>
                                                            <select style="width: 160px" id="invteritory_outlet" onchange="getPSAInv();">
                                                            </select>
                                                        </td>
                                                        <td>&nbsp;&nbsp;</td>

                                                        <td id="invpsa_label">
                                                            <label>Rep Area: </label>
                                                        </td>
                                                        <td>
                                                            <select style="width: 140px" id="invpsa_outlet" onchange="setPSAinv();">
                                                            </select>
                                                        </td>
                                                        <td>&nbsp;&nbsp;</td>
                                                        <td id="invpsazone_label">
                                                            <label>Route: </label>
                                                        </td>
                                                        <td>
                                                            <select style="width: 160px" id="invpsazone_outlet" onchange="routesetinv();">
                                                            </select>
                                                        </td>
                <!--                                        <td style="color: #0000FF">Select Speed</td>
                                                        <td>
                                                            <input type="range" id="car_range" name="car_range" max="20" min="1" value="5">
                                                        </td>-->

                                        <!--<td><input type="button" onclick="draw_live_route();" value="Draw Path"/></td>-->
                                                    </tr>
                                                </table>
                                                <!--<tr>&nbsp;</tr>-->
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <select style="width: 140px" id="time1" >
                                                            </select>
                                                        </td>
                                                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                        <td id="time2_label">
                                                        ...
                                                        <td>
                                                            <select style="width: 140px" id="time2" >
                                                            </select>
                                                        </td>
                                                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                        <td >Select Speed</td>
                                                        ...
                                                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                        <td><input type="button" onclick="draw_live_route();" value="Draw Path"/></td>
                                                        <td><input type="button" onclick="Load_Map2();" value="Clear"/></td>
                                                        <td>&nbsp;&nbsp;</td>
                                                        <td id="Pause"><input type="image" onclick="kzonec33();" id="PauseBtn" src='<?= base_url('adminlte/dist/img/gps/pause.png'); ?>'  /></td> 
                                                        <td>&nbsp;&nbsp;</td>
                                                        <td id="Resume"><input type="image" onclick="kzonec44();" id="ResumeBtn" src='<?= base_url('adminlte/dist/img/gps/play.png'); ?>' /></td> 

                                                    </tr>
                                                    <tr>
                <!--                            <td><input type="button" onclick="kzonec33();" value="Pause"/></td> 
                                            <td><input type="button" onclick="kzonec44();" value="play"/></td> -->
                                                    </tr>
                                                </table>
                                            </td>
                        ...
                        <!--<div class="center_bat" id="info_win">-->

                        <table >
                            <tr>
                                <!--<td><div class="battery plugged"><div class="level"></div></div></td>-->
                                <!--<td style="padding-right:50px;margin-left:90%;">-->
                                <td style="font-weight: bold;font-size:20px;color:red"> <label>Time:</label></td>
                                <td>
                                    <div id="win" style="font-weight: bold;font-size:20px;color: black">
