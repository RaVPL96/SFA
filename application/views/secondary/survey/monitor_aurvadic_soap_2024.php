            ...
            <option value=""> -- Select Area -- </option>    
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="submit" class="btn btn-danger" name="submit" value="Get Report" disabled>
                            </div>                                
                        </div>
                    </div>
                </form>
                <div class="col-md-12">
<h3 style="text-align: center;font-weight: bold;font-size: 34px;">Aurvedic Soap Survey Result</h3>
                    <?php
