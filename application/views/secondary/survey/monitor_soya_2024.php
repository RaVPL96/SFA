                    ...
                    if (!empty($TotalSampleDetails) && isset($TotalSampleDetails)) {
                        ...
                        <table id="survey_table" class="table table-hover">
                           ...
                           // foreach ($TotalSampleDetails as $a) {
                                ?>
                                    <td colspan="6" style="font-weight: bold;text-align: center;font-size: 19px;">LankaSoy</td>
                                    <td colspan="6" style="font-weight: bold;text-align: center;font-size: 19px;">Lakmee</td>
                                    <td colspan="6" style="font-weight: bold;text-align: center;font-size: 19px;">Freelan</td>
                                    <td colspan="6" style="font-weight: bold;text-align: center;font-size: 19px;">Delmege</td>
                                    <td colspan="6" style="font-weight: bold;text-align: center;font-size: 19px;">Fortune</td>
                                    <td colspan="6" style="font-weight: bold;text-align: center;font-size: 19px;">Wijaya</td>
                                    <td colspan="6" style="font-weight: bold;text-align: center;font-size: 19px;">Ruhunu</td>
                                    <?php
                           // }
                            ?>
                                </tr>
...
//                    print_r($TotalSampleDetails);
                            foreach ($TotalSampleDetails as $a) {
                                ...
                                <tr>
                                    ...
                                    <td><?= $a['LankaSoy_mrp'] ?></td> 
                                    <td><?= $a['LankaSoy_retail_price'] ?></td> 
                                    <td><?= $a['LankaSoy_wholesale_price'] ?></td> 
                                    <td><?= $a['LankaSoy_free_issue'] ?></td> 
                                    <td><?= $a['LankaSoy_discount'] ?></td> 
                                    <td><?= $a['LankaSoy_commit'] ?></td> 
                                    
                                    <td><?= $a['Lakmee_mrp'] ?></td> 
                                    <td><?= $a['Lakmee_retail_price'] ?></td> 
                                    <td><?= $a['Lakmee_wholesale_price'] ?></td> 
                                    <td><?= $a['Lakmee_free_issue'] ?></td> 
                                    <td><?= $a['Lakmee_discount'] ?></td> 
                                    <td><?= $a['Lakmee_commit'] ?></td> 
                                    
                                    <td><?= $a['Freelan_mrp'] ?></td> 
                                    <td><?= $a['Freelan_retail_price'] ?></td> 
                                    <td><?= $a['Freelan_wholesale_price'] ?></td> 
                                    <td><?= $a['Freelan_free_issue'] ?></td> 
                                    <td><?= $a['Freelan_discount'] ?></td> 
                                    <td><?= $a['Freelan_commit'] ?></td>
                                    
                                    <td><?= $a['Delmege_mrp'] ?></td> 
                                    <td><?= $a['Delmege_retail_price'] ?></td> 
                                    <td><?= $a['Delmege_wholesale_price'] ?></td> 
                                    <td><?= $a['Delmege_free_issue'] ?></td> 
                                    <td><?= $a['Delmege_discount'] ?></td> 
                                    <td><?= $a['Delmege_commit'] ?></td>
                                    
                                    <td><?= $a['Fortune_mrp'] ?></td> 
                                    <td><?= $a['Fortune_retail_price'] ?></td> 
                                    <td><?= $a['Fortune_wholesale_price'] ?></td> 
                                    <td><?= $a['Fortune_free_issue'] ?></td> 
                                    <td><?= $a['Fortune_discount'] ?></td> 
                                    <td><?= $a['Fortune_commit'] ?></td>
                                    
                                    <td><?= $a['Wijaya_mrp'] ?></td> 
                                    <td><?= $a['Wijaya_retail_price'] ?></td> 
                                    <td><?= $a['Wijaya_wholesale_price'] ?></td> 
                                    <td><?= $a['Wijaya_free_issue'] ?></td> 
                                    <td><?= $a['Wijaya_discount'] ?></td> 
                                    <td><?= $a['Wijaya_commit'] ?></td>
                                    
                                    <td><?= $a['Ruhunu_mrp'] ?></td> 
                                    <td><?= $a['Ruhunu_retail_price'] ?></td> 
                                    <td><?= $a['Ruhunu_wholesale_price'] ?></td> 
                                    <td><?= $a['Ruhunu_free_issue'] ?></td> 
                                    <td><?= $a['Ruhunu_discount'] ?></td> 
                                    <td><?= $a['Ruhunu_commit'] ?></td>
