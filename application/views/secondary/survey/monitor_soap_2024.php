        ...
        <select id="sbArea" class="form-control">
            <option value=""> -- Select Area -- </option>    
                ...
                <div class="col-md-12">
                     ...
                     <h3 style="text-align: center;font-weight: bold;font-size: 34px;"> Survey Result</h3>
                ...
                <!--<h1 style="text-align: center;font-weight: bold;"> Survey Result Area Totals</h1> -->
    ...
    window.onload = function() {
        ...
        var myBarChart = new Chart(ctx, {
            ...
            options: {
                ...
                <h1 style="text-align: center;font-weight: bold;">Laundary Soap Survey Detail Result</h1> 
                        ...
                        <table id="survey_table" class="table table-hover">
                           ...
                           // foreach ($TotalSampleDetails as $a) {
                                ?>
                                    <td colspan="4" style="font-weight: bold;text-align: center;font-size: 19px;">Diva</td>
                                    <td colspan="4" style="font-weight: bold;text-align: center;font-size: 19px;">Sunlight</td>
                                    <td colspan="4" style="font-weight: bold;text-align: center;font-size: 19px;">Starlight</td>
                                    <td colspan="4" style="font-weight: bold;text-align: center;font-size: 19px;">Kingdo</td>
                                    <td colspan="4" style="font-weight: bold;text-align: center;font-size: 19px;">Wonderlight</td>
                                    <td colspan="4" style="font-weight: bold;text-align: center;font-size: 19px;">Pearl_White</td>
                                    <td colspan="4" style="font-weight: bold;text-align: center;font-size: 19px;">Dash</td>
                                    <?php
                           // }
                            ?>
                                </tr>
...
//                    print_r($TotalSampleDetails);
                            ...
                            $starlight_available = 0;
                            $kingdo_available = 0;
                            $wonderlight_available = 0;
                            $pearl_White_available = 0;
                            $dash_available = 0;
                            foreach ($TotalSampleDetails as $a) {
                            $diva_available = $diva_available+$a['Diva_available'];
                            $sunlight_available = $sunlight_available+$a['Sunlight_available'];
                            $starlight_available = $starlight_available+$a['Starlight_available'];
                            $kingdo_available = $kingdo_available+$a['Kingdo_available'];
                            $wonderlight_available = $wonderlight_available+$a['Wonderlight_available'];
                            $pearl_White_available = $pearl_White_available+$a['Pearl_White_available'];
                            $dash_available = $dash_available+$a['Dash_available'];
                                ?>
                                <tr>
                                    <td><?= $a['area_name'] ?></td> 
                                    <td><?= $a['territory_name'] ?></td> 
                                    ...
                                    <td><?= $a['Diva_size'] ?></td> 
                                    <td><?= $a['Diva_available'] ?></td> 
                                    <td><?= $a['Diva_free_issue'] ?></td> 
                                    <td><?= $a['Diva_discount'] ?></td> 
                                    
                                    <td><?= $a['Sunlight_size'] ?></td> 
                                    <td><?= $a['Sunlight_available'] ?></td> 
                                    <td><?= $a['Sunlight_free_issue'] ?></td> 
                                    <td><?= $a['Sunlight_discount'] ?></td> 
                                     
                                    <td><?= $a['Starlight_size'] ?></td> 
                                    <td><?= $a['Starlight_available'] ?></td> 
                                    <td><?= $a['Starlight_free_issue'] ?></td> 
                                    <td><?= $a['Starlight_discount'] ?></td> 
                                    
                                    <td><?= $a['Kingdo_size'] ?></td> 
                                    <td><?= $a['Kingdo_available'] ?></td> 
                                    <td><?= $a['Kingdo_free_issue'] ?></td> 
                                    <td><?= $a['Kingdo_discount'] ?></td> 
                                    
                                    <td><?= $a['Wonderlight_size'] ?></td> 
                                    <td><?= $a['Wonderlight_available'] ?></td> 
                                    <td><?= $a['Wonderlight_free_issue'] ?></td> 
                                    <td><?= $a['Wonderlight_discount'] ?></td>

                                    <td><?= $a['Pearl_White_size'] ?></td> 
                                    <td><?= $a['Pearl_White_available'] ?></td> 
                                    <td><?= $a['Pearl_White_free_issue'] ?></td> 
                                    <td><?= $a['Pearl_White_discount'] ?></td>  

                                    <td><?= $a['Dash_size'] ?></td> 
                                    <td><?= $a['Dash_available'] ?></td> 
                                    <td><?= $a['Dash_free_issue'] ?></td> 
                                    <td><?= $a['Dash_discount'] ?></td>  
                            ...
                            <tr>
                                ...
                                <td>&nbsp;</td> 
                                <td style="font-weight: bold;font-size: 15px;text-align: center;color: black;"><?= $diva_available ?></td> 
                                <td>&nbsp;</td> 
                                <td>&nbsp;</td> 

                                <td>&nbsp;</td> 
                                <td style="font-weight: bold;font-size: 15px;text-align: center;color: black;"><?= $sunlight_available ?></td> 
                                <td>&nbsp;</td> 
                                <td>&nbsp;</td> 

                                <td>&nbsp;</td> 
                                <td style="font-weight: bold;font-size: 15px;text-align: center;color: black;"><?= $starlight_available ?></td> 
                                <td>&nbsp;</td> 
                                <td>&nbsp;</td> 

                                <td>&nbsp;</td> 
                                <td style="font-weight: bold;font-size: 15px;text-align: center;color: black;"><?= $kingdo_available ?></td> 
                                <td>&nbsp;</td> 
                                <td>&nbsp;</td> 

                                <td>&nbsp;</td> 
                                <td style="font-weight: bold;font-size: 15px;text-align: center;color: black;"><?= $wonderlight_available ?></td> 
                                <td>&nbsp;</td> 
                                <td>&nbsp;</td> 

                                <td>&nbsp;</td> 
                                <td style="font-weight: bold;font-size: 15px;text-align: center;color: black;"><?= $pearl_White_available ?></td> 
                                <td>&nbsp;</td> 
                                <td>&nbsp;</td> 

                                <td>&nbsp;</td> 
                                <td style="font-weight: bold;font-size: 15px;text-align: center;color: black;"><?= $dash_available ?></td> 
                                <td>&nbsp;</td> 
                                <td>&nbsp;</td> 
