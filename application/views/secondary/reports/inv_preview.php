                    ...
                    <table style="width:900px; height:633px">
                        <tbody>
                                ...
                                <td>
                                    ...
                                    <div id="div_view_invoice" align="center">
                                        ...
                                        <table class="sub-table-grey" style="width:820px;">
                                            <tbody>
                                                <tr>
                                                    <td style="width: 100px; font-weight:bold;" class="sub-table-content">Invoice Date</td>
                                                    <td style="width: 1px" class="sub-table-content">:</td>
                                                    <td class="sub-table-content"><?= $invDataH->date_actual ?></td>
                                                    <td class="sub-table-content"></td>
                                                    <td style="width: 100px; font-weight:bold;" class="sub-table-content">Order Date</td>
                                                    <td style="width: 1px" class="sub-table-content">:</td>
                                                    <td class="sub-table-content"><?= $invDataH->date_book ?></td>
                                                </tr>
                                                <tr>
                            ...
                            <!--            <td style="width: 100px; font-weight:bold;" class="sub-table-content">Zone Name</td>
                                                    ...
                                                    <td style="width: 1px" class="sub-table-content">:</td>
                                                    <td class="sub-table-content"><?= $invDataH->invno ?></td>
                                                                        ...
                                                                        <table border="0">
                                                                            <thead>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td style=" padding: 5px;"><input disabled="disabled" id="sub_total_amount" name="invoice_return_total_amount" style="text-align: right" type="text" value="<?= ($invDataH->subtotal)?>">
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    <td style=" padding: 5px;">Header Discount (<?= $invDataH->header_discount_value ?>%)</td> -->
                                                                                    <td style=" padding: 5px;">:<font style="font-size: 13px"> Rs. </font></td>
