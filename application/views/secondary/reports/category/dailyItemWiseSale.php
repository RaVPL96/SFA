...
<div class="content-wrapper">
    ...
    <section class="content" style="overflow:hidden;">
        ...
        <div class="row">
            <div class="col-md-12">  
                <form class="form-horizontal" id="myForm" action="<?= base_url('Itemreports/dailyItemWiseSale') ?>" method="post">
<!--                    <div class="col-md-4">                            
                    ...
                    <table id="attendance_table" class="table table-hover presentation">
                        ...
                        <tr>
                            ...
                            for ($i = $begin; $i <= $end; $i->modify('+1 day')) {
                                    $date = $i->format("d");
                                    ?>
                            <td style="text-align: right"><?php echo $d['date_'.$date]; ?></td>
                                <?php   
                                }
                                ?>
                                <td style="text-align: right"><?php echo number_format($d['totQty']); ?></td>
                                <td style="text-align: right"><?php echo number_format($d['totVal']); ?></td>
                        </tr>
                        <?php
                        }
                        ?>
