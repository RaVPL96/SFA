...
<div class="content-wrapper">
    ...
    <section class="content" style="overflow:hidden;">
        ...
        <div class="row">
            <div class="col-md-12">  
                <form class="form-horizontal" id="myForm" action="<?= base_url('salesreports/pendingBillReport') ?>" method="post">
                    <div class="col-md-4">                            
        ...
        <div class="col-md-12" style="overflow-x: scroll; overflow-y: scroll; max-height: 700px;">
            <?php
            if (!empty($BillReport) && isset($BillReport)) {
                ?>
                <h2>Pending Bill Report 
                </h2>
                ...
                <table id="attendance_table" class="table table-hover presentation">
                    <thead>
                        <tr>
                            ...
                            <th>Pending Value</th>
                            <th>Actual Value</th>
                            <th>Full Cancel Value</th>

                    </thead>
                    <?php
                    foreach ($BillReport as $d) {
