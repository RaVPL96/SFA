        ...
        <div class="row">
            <div class="col-md-12" style="overflow-x: scroll;">
                ...
                <form class="form-horizontal" id="" action="<?= base_url('salesreports/dailyAchievementSummeryItem') ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select id="reportType" name="reportType" class="form-control">
                                    ...
                                    <option value="iw">Item Wise</option>
                                    <option value="iaw">Item Area Wise</option>
                                    <option value="caw">Category Area Wise</option>
                                    <option value="ctw">Category Territory Wise</option>
                                    <option value="itw">Item Territory Wise</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <?php
                            if(!empty($getAllData) && isset($getAllData)){
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                <?php 
                                if(!empty($getAllData['categoryName']) && isset($getAllData['categoryName'])){
                                    ?>
                                <th>CategoryName</th>
                                ...
                                if(!empty($getAllData['territoryName']) && isset($getAllData['territoryName'])){
                                    ?>
                                ...
                                if(!empty($getAllData['areaName']) && isset($getAllData['areaName'])){
                                    ?>
                                <th>Area Name</th>
                                <?php
                                }
                            ...
                            foreach ($getAllData AS $dataSet) {
                                ?>
                            
                                
                            <tr>
                                <?php 
                                if(!empty($dataSet['categoryName']) && isset($dataSet['categoryName'])){
                                    ?>
                                <td><?php echo $dataSet['categoryName'] ?></td>
                                
                                <?php
                                }
                                
                                if(!empty($dataSet['territoryName']) && isset($dataSet['territoryName'])){
                                    ?>
                                <td><?php echo $dataSet['territoryName'] ?></td>

                                
                                <?php
                                }
                                
                                if(!empty($dataSet['areaName']) && isset($dataSet['areaName'])){
                                    ?>
                                <td><?php echo $dataSet['areaName'] ?></td>
                                <?php
                                }
                                ...
                                ?>
                                <td><?php echo $dataSet['aQty'] ?></td>
                                <td><?php echo $dataSet['bQty'] ?></td>
                                <td><?php echo $dataSet['cQty'] ?></td>
                                <td><?php echo $dataSet['mQty'] ?></td>
                                <td><?php echo $dataSet['g_qty'] ?></td>
                                <td><?php echo $dataSet['f_qty'] ?></td>
                            </tr>
