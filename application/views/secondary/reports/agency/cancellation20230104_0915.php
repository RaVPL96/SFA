                        ...
                        if (!empty($dataInfo) && isset($dataInfo)) {
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <?php echo number_format($dataInfo->total_count); ?>
                                        </td>
                                        <td>
                                            <?php echo number_format($dataInfo->total_cancel_value, 2); ?>
                                        </td>
                                        <td>
                                            <?php echo number_format($dataInfo->total_booking_value, 2); ?>
                                        </td>
                                        <td>
                                            <?php echo number_format($dataInfo->total_cancel_value / $dataInfo->total_booking_value * 100, 2) . '%'; ?>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
