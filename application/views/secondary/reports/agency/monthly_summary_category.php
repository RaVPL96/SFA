...
<div class="content-wrapper">    <!-- Content Header (Page header) -->    
    <section class="content-header">       
        <h1>            Monthly Summary Report (Category)          <small>Review O/E Transactions </small>        </h1>  
        <ol class="breadcrumb">       
        ...
        <div class="row">            
            <div class="col-md-12">               
                ...
                <div class="row" style="overflow-x: scroll;">   
                    <div class="col-md-12">                 
                        <form class="form-horizontal" id="OrderData" action="<?= base_url('salesreports/monthlySummaryCategory') ?>" method="post" novalidate="novalidate">             
                            <div class="col-md-6">       
