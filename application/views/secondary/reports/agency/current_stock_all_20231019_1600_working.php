...
<div class="content-wrapper" style="height: 300px;    overflow-y: auto;">
                    ...
                    if (!empty($StockDataSum) && isset($StockDataSum)) {
                        ...
                        <table id="attendance_table" class="table table-hover">	
                            ...
                            foreach ($StockDataSum as $s) {
                                ...
                                $strDaySummery .= '<tr>'
                                        . '<td colspan="1" class="sticky-col first-col " style="text-align:right">Summery</td>'
                                        . '<td colspan="1">' . $s['description'] . '</td>'
                                        . '<td colspan="1">' . $s['uom'] . '</td>'
                                        . '<td colspan="1" style="text-align:right;">' . $s['op_sellable'] . '</td>'
                                        . '<td colspan="1" style="text-align:right;">' . $s['op_damage'] . '</td>'
                                        . '<td colspan="1" style="text-align:right;">' . $s['invoice_a_qty'] . '</td>'
                                        . '<td colspan="1" style="text-align:right;">' . $s['invoice_f_qty'] . '</td>'
                                        . '<td colspan="1" style="text-align:right;">' . $s['invoice_g_qty'] . '</td>'
                                        . '<td colspan="1" style="text-align:right;">' . $s['invoice_g_free_qty'] . '</td>'
                                        . '<td colspan="1" style="text-align:right;">' . $s['invoice_m_qty'] . '</td>'
                                        . '<td colspan="1" style="text-align:right;">' . $s['invoice_m_free_qty'] . '</td>'
                                        . '<td colspan="1" style="text-align:right;">' . $s['good_return_qty'] . '</td>'
                                        . '<td colspan="1" style="text-align:right;">' . $s['market_return_qty'] . '</td>'
                                        . '<td colspan="1" style="text-align:right;">' . $s['head_office_inv_qty'] . '</td>'
                                        . '<td colspan="1" style="text-align:right;">' . $s['head_office_inv_qty_pending_accept'] . '</td>'
                            ...
                            $strDaySummeryFoot = '<tr>'
                                    ...
                                    . '<td colspan="1" style="text-align:right;">' . number_format($invFreeQty) . '</td>'
                                    . '<td colspan="1" style="text-align:right;">' . number_format($invGretQty) . '</td>'
                                    . '<td colspan="1" style="text-align:right;">' . number_format($invGretFreeQty) . '</td>'
                                    . '<td colspan="1" style="text-align:right;">' . number_format($invMretQty) . '</td>'
                                    . '<td colspan="1" style="text-align:right;">' . number_format($invMretFreeQty) . '</td>'
                                    . '<td colspan="1" style="text-align:right;">' . number_format($invHFGretQty) . '</td>'
                                    . '<td colspan="1" style="text-align:right;">' . number_format($invHFMretQty) . '</td>'
                            ...
                            <thead>						
                                <tr>	
                                    <th class="sticky-col first-col ">Agency Name</th>
                                    ...
                                    <th colspan="1" style="background: #fdff62;">Closing (Sellable+Pending)</th>
                                    <th colspan="1" style="background: #ffadad;">Closing (Damaged)</th>
                                    <th colspan="1" style="background: #00cc00;">Value Closing (Sellable)</th>
                                    <th colspan="1" style="background: #fdff62;">Value Closing (Sellable+Pending)</th>
                                    <th colspan="1" style="background: #ffadad;">Value Closing (Damaged)</th>	
                                </tr>		
                            </thead>
                            <tbody>	 
                                <?= $strDaySummery ?>               			
                            ...
                            <table id="attendance_table_d" class="table table-hover presentation">	
                                ...
                                foreach ($StockData as $s) {
                                    ...
                                    $strDaySummeryDetail .= '<tr>'
                                            . '<td colspan="1" class="sticky-col first-col "><a target="_blank" href="' . base_url('salesreports/stockLog/' . $s['location_code'] . '/' . $RangeID . '/' . $s['item']) . '">' . $s['agency_name'] . ' (' . $s['agency_code'] . ')</a></td>'
                                            . '<td colspan="1">' . $s['description'] . '</td>'
                                            . '<td colspan="1">' . $s['uom'] . '</td>'
                                            . '<td colspan="1" style="text-align:right;">' . $s['op_sellable'] . '</td>'
                                            . '<td colspan="1" style="text-align:right;">' . $s['op_damage'] . '</td>'
