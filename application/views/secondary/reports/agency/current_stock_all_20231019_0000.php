        ...
        <div class="row">
            <div class="col-md-12" style="overflow-x: scroll;">
                    ...
                    <table id="attendance_table" class="table table-hover">	
                        ...
                        foreach ($StockDataSum as $s) {
                            ...
                            $strDaySummery .= '<tr>'
                                    ...
                                    . '<td colspan="1" style="background: #00cc00; font-weight:bold">' . number_format($closing_sellable) . '</td>'
                                    . '<td colspan="1" style="background: #fdff62;">' . number_format($closingSellableWithPendingInv) . '</td>'
                                    . '<td colspan="1" style="background: #ffadad;">' . number_format($closing_damaged) . '</td>'
                                    . '</tr>';
                        }
                        $strDaySummeryFoot = '<tr>'
                                . '<td colspan="3">Total Summery</td>'
                                . '<td colspan="1">' . number_format($opSellableTot) . '</td>'
                                . '<td colspan="1">' . number_format($opDamageTot) . '</td>'
                                . '<td colspan="1">' . number_format($invActualQty) . '</td>'
                                . '<td colspan="1">' . number_format($invFreeQty) . '</td>'
                                . '<td colspan="1">' . number_format($invGretQty) . '</td>'
                                . '<td colspan="1">' . number_format($invGretFreeQty) . '</td>'
                                . '<td colspan="1">' . number_format($invMretQty) . '</td>'
                                . '<td colspan="1">' . number_format($invMretFreeQty) . '</td>'
                                . '<td colspan="1">' . number_format($invHFGretQty) . '</td>'
                                . '<td colspan="1">' . number_format($invHFMretQty) . '</td>'
                                . '<td colspan="1">' . number_format($invHFInvQty) . '</td>'
                                . '<td colspan="1">' . number_format($invHFPendingInvQty) . '</td>'
                                . '<td colspan="1" style="background: #00cc00; font-weight:bold">' . number_format($closingSellableTot,0) . '</td>'
                                . '<td colspan="1" style="background: #fdff62;">' . number_format($closingSellableWithPendingTot,0) . '</td>'
                                . '<td colspan="1" style="background: #ffadad;">' . number_format($closingDamageTot,0) . '</td>'
                                . '</tr>';
                        ?>
                ...
                if (!empty($StockData) && isset($StockData)) {
                    ...
                    <table id="attendance_table_d" class="table table-hover">	
                        <?php
                        foreach ($StockData as $s) {
                            ...
                            $strDaySummeryDetail .= '<tr>'
                                    ...
                                    . '<td colspan="1">' . $s['head_office_inv_qty'] . '</td>'
                                    . '<td colspan="1">' . $s['head_office_inv_qty_pending_accept'] . '</td>'
                                    . '<td colspan="1" style="background: #00cc00; font-weight:bold">' . number_format($closing_sellable,0) . '</td>'
                                    . '<td colspan="1" style="background: #fdff62;">' . number_format($closing_sellablewithPending,0) . '</td>'
                                    . '<td colspan="1" style="background: #ffadad;">' . number_format($closing_damaged,0) . '</td>'
                                    . '</tr>';
                        }
                        ?> 
