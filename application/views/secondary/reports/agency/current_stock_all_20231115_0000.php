                    ...
                    <table id="attendance_table" class="table table-hover">	
                        ...
                        foreach ($StockDataSum as $s) {
                            ...
                            $strDaySummery .= '<tr>'
                                    ...
                                    . '<td colspan="1" style="text-align:right;">' . number_format($s['invoice_f_qty']) . '</td>'
                                    . '<td colspan="1" style="text-align:right;">' . number_format($s['invoice_g_qty']) . '</td>'
                                    . '<td colspan="1" style="text-align:right;">' . number_format($s['invoice_g_free_qty']) . '</td>'
                                    . '<td colspan="1" style="text-align:right;">' . number_format($s['invoice_m_qty']) . '</td>'
                                    . '<td colspan="1" style="text-align:right;">' . number_format($s['invoice_m_free_qty']) . '</td>'
                                    . '<td colspan="1" style="text-align:right;">' . number_format($s['good_return_qty']) . '</td>'
                                    . '<td colspan="1" style="text-align:right;">' . number_format($s['market_return_qty']) . '</td>'
