        ...
        <div class="row">
            <div class="col-md-12" style="">
                ...
                if (!empty($StockData) && isset($StockData)) {
                    ...
                    <div class="form-group col-md-6" style="z-index: 100;">
                ...
                <div class="form-group col-md-6" style="z-index: 100;">
                    <input type="button" class="btn btn-warning" id="colomnStatus" name="colomnStatus" onclick="hideTableColomns(); return false;" value="Show Detail Report">
                    </div>
                    <div class="wrappers">
                        <table id="attendance_table_d" class="table table-hover presentation">	
                            ...
                            <tfoot>
                                <tr style="font-size: 14px; font-weight: bold;">
                                    ...
                                    if (!empty($AreaID) && isset($AreaID)) {
                                        ?>
                                    <td colspan="18" id="totalTextField" style="text-align:right;">Total Value</td> 
                                        <?php
                                    } else {
                                        ?>
                                        <td colspan="18" id="totalTextField" style="text-align:right;">Total Value</td> 
