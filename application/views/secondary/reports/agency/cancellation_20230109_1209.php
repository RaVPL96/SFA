                                ...
                                <tbody>
                                    <?php foreach ($territoryData as $r) {
                                        ...
                                        <tr>
                                            ...
                                            <td> <?= $r['total_count'] ?></td>
                                            <td> <?= number_format($r['total_cancel_value'], 2) ?></td>
                                            <td> <?= number_format($r['total_booking_value'], 2) ?></td>
                                            <td> <?= number_format($r['total_cancel_value'] / $r['total_booking_value'] * 100, 2) ?>%</td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
