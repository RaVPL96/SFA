                ...
                if (!empty($SalesData) && isset($SalesData)) {
                    ...
                    foreach ($SalesDataTerritory as $s) {
                        ...
                        $strDaySummery .= '<tr>'
                                ...
                                . '<td colspan="1" align="right">' . number_format(($s['totGval'] / ($s['totAval'] + $s['totDisval'])) * 100) . ' %</td>'
                                . '<td colspan="1" align="right">' . number_format($s['totMval']) . '</td>'
                                . '<td colspan="1" align="right">' . number_format(($s['totMval'] / ($s['totAval'] + $s['totDisval'])) * 100) . ' %</td>'
                                . '<td colspan="1" align="right">' . number_format($s['totGval'] + $s['totMval']) . '</td>'
                                . '<td colspan="1" align="right">' . number_format((($s['totGval'] + $s['totMval']) / ($s['totAval'] + $s['totDisval']) * 100)) . ' %</td>'
