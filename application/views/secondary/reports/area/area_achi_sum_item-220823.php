            ...
            <div class="col-md-12" style="overflow-x: scroll;">
                            ...
                            <div class="col-md-6">
                                <select id="sbCategory" name="categoryID" class="form-control">
                                    ...
                                    foreach ($CategoryList as $c) {
                                        $select = '';
                                        if (!empty($CategoryID) && isset($CategoryID) && $c['id'] == $CategoryID) {
                                            $select = 'selected';
                                        }
                                        echo '<option ' . $select . ' value="' . $c['name'] . '"> ' . $c['name'] . '</option>';
                                    }
                                    ?>
                                </select>
                            </div>
                ...
                if (!empty($SalesData) && isset($SalesData)) {
                    ...
                    foreach ($SalesDataTerritory as $s) {
                        ...
                        if ($strTerritory == $s['cat']) {//add totals to same territory figures
                            $item = $s['item'];
                            $des = $s['des'];
                            $cat = $s['cat'];
                            $Qty = $Qty + $s['Qty'];
...
/*                            $totTerrCancelPC = $totTerrCancelPC + $s['totValue'];
                        ...
                        if ($strTerritory != $s['cat'] || $c == $totalRows - 1) {

                            $strTerritorySummery .= '<tr>'
                                    //. '<td colspan="2"><a target="_blank" href="' . base_url('salesreports/areaSummery/null/' . $AreaID . '/' . $RangeID . '/' . $strTerritoryID . '/' . $dt . '/' . $billMethod) . '">' . $strTerritory . '</td>'
                                    . '<td colspan="1">' . $item . '</td>'
                                    . '<td colspan="1">' . $des . '</td>'
                                    . '<td colspan="1">' . $cat . '</td>'
                                    . '<td colspan="2" align="right">' . number_format($Qty) . '</td>'
                                    . '<td colspan="1" align="right">' . number_format($Val) . '</td>'
                                    /*. '<td colspan="1" align="right">' . number_format($totTerrGValue) . '</td>'
                                    . '<td colspan="1" align="right">' . number_format(($totTerrGValue / $totTerrAValue) * 100) . ' %</td>'
                                    . '<td colspan="1" align="right">' . number_format($totTerrMValue) . '</td>'
                                    . '<td colspan="1" align="right">' . number_format(($totTerrMValue / $totTerrAValue) * 100) . ' %</td>'
                                    . '<td colspan="1" align="right">' . number_format(($totTerrMValue + $totTerrGValue)) . '</td>'
                                    . '<td colspan="1" align="right">' . number_format((($totTerrMValue + $totTerrGValue) / $totTerrAValue) * 100) . ' %</td>'
                           ...
                           /* $totTerrBills = $totTerrBills + $s['totBills'];
                            ...
                            if ($strTerritory != $s['cat'] && $c == $totalRows - 1) {//last row new territory and need to display
                                $strTerritory = $s['cat'];
                                $strTerritorySummery .= '<tr>'
//                                        . '<td colspan="2"><a target="_blank" href="' . base_url('salesreports/areaSummery/null/' . $AreaID . '/' . $RangeID . '/' . $strTerritoryID . '/' . $dt . '/' . $billMethod) . '">' . $strTerritory . '</td>'
                                        . '<td colspan="1">' . $item . '</td>'
...
//                            $dateBill = $s['date_actual'];
                       ...
                       // $totalActual=$s['totAval'] + $s['totDisval'];
                        ...
                        $strDaySummery .= '<tr>'
                                //. '<td  colspan="1"><a href="' . base_url('salesreports/areaSummery/null/' . $AreaID . '/' . $categoryID . '/' . $dt . '/' . $billMethod . '/' . $dateBill) . '">' . $dateBill . '</a></td>'
                                . '<td  colspan="1">' . $s['item'] . '</td>'
                                . '<td  colspan="1">' . $s['des'] . '</td>'
                                . '<td  colspan="1">' . $s['cat'] . '</td>'
                                . '<td  colspan="1">' . $s['Qty'] . '</td>'
                                . '<td  colspan="1">' . $s['Val'] . '</td>'
                               ...
                               /* . '<td colspan="1">' . $s['totBills'] . '</td>'
                                ...
                                . '<td colspan="1" align="right">' . number_format(($s['totGval'] / ($totalActual)) * 100) . ' %</td>'
                                . '<td colspan="1" align="right">' . number_format($s['totMval']) . '</td>'
                                . '<td colspan="1" align="right">' . number_format(($s['totMval'] / ($totalActual)) * 100) . ' %</td>'
                                . '<td colspan="1" align="right">' . number_format($s['totGval'] + $s['totMval']) . '</td>'
                                . '<td colspan="1" align="right">' . number_format((($s['totGval'] + $s['totMval']) / ($totalActual) * 100)) . ' %</td>'
                    ...
                    <div class="clearfix">&nbsp;</div><br>
                            ...
                            <table id="attendance_table" class="table table-hover">	
                                <thead>
                                <th colspan="17" style="font-size: 20px; text-align: center;"> <?= $AreaDetails->area_name ?> Area Actual Sales Data - <?= $cat->cat ?> Category <br>Date From <?= $DateRange ?></th>
                                </thead>
                                <thead>						
                                    <tr>	
                                ...
                                <tbody>	 
                                    <tr>		 
                                        <td colspan="1" align="right"><?= $item ?></td> 
                                        <td colspan="1" align="right"><?= $des ?></td> 
                                        <td colspan="1" align="right"><?= $cat ?></td> 
                                        <td colspan="2" align="right"><?= number_format($Qty) ?></td>                                 
                                        <td colspan="1" align="right"><?= number_format($Val) ?></td>
                                        ...
                                        <td colspan="1" align="right"><?= number_format(($totGValue / $totAValue) * 100) ?> %</td>
                                        <td colspan="1" align="right"><?= number_format($totMValue) ?></td>
                                        <td colspan="1" align="right"><?= number_format(($totMValue / $totAValue) * 100) ?> %</td>
                                        <td colspan="1" align="right"><?= number_format(($totMValue + $totGValue)) ?></td>
                                        <td colspan="1" align="right"><?= number_format((($totMValue + $totGValue) / $totAValue) * 100) ?> %</td>
