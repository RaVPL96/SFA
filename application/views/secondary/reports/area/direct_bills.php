                    ...
                    <div class="col-md-6">                            
                        ...
                        <div class="col-md-6">                            
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <select id="RangeList" name="rangeID" class="form-control">
                                        <option value="-1"> -- Select Range -- </option>    
                                        <?php
                                        foreach ($RangeList as $a) {
                                            $select = '';
                                            if (!empty($RangeID) && isset($RangeID) && $a['cd'] == $RangeID) {
                                                $select = 'selected';
                                            }

                                            if ($sess['grade_id'] == 4) {
                                                foreach ($ASE_Area as $ase) {
                                                    if ($ase['range_id'] == $a['cd']) {
                                                        echo '<option ' . $select . ' value="' . $a['cd'] . '"> ' . $a['cd'] . '</option>';
                                                    }
                                                }
                                            } else {
                                                echo '<option ' . $select . ' value="' . $a['cd'] . '"> ' . $a['cd'] . '</option>';
