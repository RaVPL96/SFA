...
<style>
    ...
    thead tr th{
        background: #0070c0 !important;color:#ffffff;
    }
    .wrappers {
        position: relative;
        /*overflow: auto;*/
                ...
                if (!empty($SalesData) && isset($SalesData)) {
                    ...
                    foreach ($SalesDataTerritory as $s) {
                        ...
                        if ($strTerritory != $s['territory_name'] || $c == $totalRows - 1) {
                            ...
                            $strTerritorySummery .= '<tr>'
                                    . '<td class="sticky-col first-col " colspan="2"><a target="_blank" href="' . base_url('salesreports/areaSummery/null/' . $AreaID . '/' . $RangeID . '/' . $strTerritoryID . '/' . $dt . '/' . $billMethod) . '">' . $strTerritory . '</td>'
                                    . '<td colspan="1" style="background: #66ff33;" align="right">' . number_format($targetV) . '</td>'
                                    . '<td colspan="1" style="background: #ffff00;" align="right">' . number_format($totTerrAValue) . '</td>'
                    ...
                    foreach ($targetData as $target) {
                        ...
                        if ($targetV != 0 && !in_array($target['ag_cd'], $territory_list_array)) {//IF NOT IN ARRAY CREATE A EMPTY SUMMERY LINE WITH 0 TARGET SUMMERY
                            ...
                            $strTerritorySummery .= '<tr>'
                                    . '<td  class="sticky-col first-col "  colspan="2"><a target="_blank" href="#">' . $target['ag_name'] . '</td>'
                                    . '<td colspan="1" style="background: #66ff33;" align="right">' . number_format($targetV) . '</td>'
                                    . '<td colspan="1" style="background: #ffff00;" align="right">' . number_format(0) . '</td>'
                    ...
                    <div class="row">
                        <table id="attendance_table" class="table table-hover">
                            ...
                            <tbody>
                                <tr>
                                    <td colspan="1" align="right" style="background: #66ff33;"><?= number_format($totTargetValue) ?></td>
                                    <td colspan="1" align="right" style="background: #ffff00;"><?= number_format($totAValue) ?></td>
