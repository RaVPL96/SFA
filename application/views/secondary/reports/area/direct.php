...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Secondary Sales Distributor Direct
            <small>Distributor Direct Report </small>
        </h1>
        <ol class="breadcrumb">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-6">                            
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select id="sbDirect" name="directID" class="form-control">
                                    <option value="-1"> -- Select -- </option>    
                                    <?php
                                    foreach ($DirectList as $d) {
                                        $select = '';
                                        if (!empty($DirectID) && isset($DirectID) && $d['id'] == $DirectID) {
                                            $select = 'selected';
                                        }
                                        echo '<option ' . $select . ' value="' . $d['d'] . '"> ' . $d['d'] . '</option>';
                                    }
                                    ?>
                                </select>
                            </div>
