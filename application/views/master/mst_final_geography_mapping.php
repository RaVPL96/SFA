        ...
        <div class="row">
            <div class="col-md-4">
                ...
                if (!empty($GeoDataLine) && isset($GeoDataLine)) {
                    ...
                    $agentusername=$GeoDataLine->agent_username;
                    ...
                    <fieldset>
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12">Distributor User Name <span class="text-red">*</span></label> 
                                    <select id="sbRange" name="sop[distributor_username]" class="form-control">
                                        <option value="-1"> -- Select Distributor Username-- </option>    
                                        <?php
                                        foreach ($DistributorLoginUserDataSet as $a) {
                                            $select = '';
                                            if ($agentusername == $a['username']) {
                                                $select = 'selected="selected"';
                                            }
                                            echo '<option ' . $select . ' value="' . $a['username'] . '"> ' . $a['username'] . ' - ' . $a['profname'] . ' </option>';
                                        }
                                        ?>
                                    </select> 
                                </div> 
                        ...
                        <table class="table table-bordered" id="example1">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 40px">Agent Username</th>
