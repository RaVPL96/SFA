...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <small>Maintain Secondary Sales Channel Details </small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-6">
				...
				$isdelval = '';
                $btnmsg = 'Create Sales Channel';
                if (!empty($ChannelData) && isset($ChannelData)) {
                    $channelName = $ChannelData->channel_name;
                    $lid = $ChannelData->id;
					//$oplid = $ZoneData->op_id;
                    $isact = $ChannelData->is_act;
					$isdel = $ChannelData->is_del;
                    $readLvl = 'disabled=disabled';
                    $btnmsg = 'Update Sales Channel';
                    if ($isact == 1) {
                        $isactval = 'checked="checked"';
                    } else {
                        $isactval = '';
                ...
                <form id="frmLocation" role="form" action="<?= base_url('index.php/master/saveChannel') ?>" method="post">
                    <fieldset>
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">Channel Layer</h3> (Enter Channel Layer Details)  <a class="btn btn-success pull-right btn-sm" href="<?= base_url('index.php/master/createChannel/') ?>"><i class="fa fa-plus"></i> New</a>                              
                            </div><!-- /.box-header -->
                            <div class="box-body">
								
                                <div class="form-group">
                                    <input type="text" name="sop[channelName]" class="form-control" value="<?= $channelName ?>" placeholder="Enter Name for channel architecture">
                                </div>
                                <div class="form-group"> 
            ...
            <div class="col-md-6">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Sales Channel List</h3> (Click Edit to change details)
                    </div><!-- /.box-header -->
                    <div class="box-body">
