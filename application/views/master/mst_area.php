...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Sales Geography - Area Architecture
            <small>Maintain Secondary Sales Area Details </small>
        </h1>
        <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                if (!empty($AreaData) && isset($AreaData)) {
                    $areaName = $AreaData->region_name;
                    $lid = $AreaData->id;
					$refCode = $AreaData->reference_code;
                    $isact = $AreaData->is_act;
					$isdel = $AreaData->is_del;
                ...
                <form id="frmLocation" role="form" action="<?= base_url('index.php/master/saveArea') ?>" method="post">
                    <fieldset>
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">Area Geography Layer</h3> (Enter Area Layer Details)  <a class="btn btn-success pull-right btn-sm" href="<?= base_url('index.php/master/createArea/') ?>"><i class="fa fa-plus"></i> New</a>                              
                            </div><!-- /.box-header -->
                            <div class="box-body">
								
                                <div class="form-group">
                                    <input type="text" name="sop[areaName]" class="form-control" value="<?= $areaName ?>" placeholder="Enter Name for Area architecture">
                                </div>
                                <div class="form-group">
                                    <input type="text" name="sop[areaCode]" class="form-control" value="<?= $refCode ?>" placeholder="Enter Code for Area architecture">
                                </div>
                                <div class="form-group"> 
