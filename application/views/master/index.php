    ...
    <section class="content">
        <div class="row">
            <div class="col-md-6">
                ...
                <form id="frmLocation" role="form" action="<?= base_url('index.php/master/updateSalesOp') ?>" method="post">
                    <fieldset>
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">Sales Operation Details</h3> (Enter Sales Operation Details)  <a class="btn btn-success pull-right btn-sm" href="<?= base_url('index.php/master/salesOperations/') ?>"><i class="fa fa-plus"></i> New</a>                              
                            </div><!-- /.box-header -->
                            <div class="box-body">
                                <div class="form-group">
                                    <input type="text" name="sop[name]" class="form-control" value="<?= $locname ?>" placeholder="Enter Name for the location">
                                </div>
                                <div class="form-group"> 
                                    <div class="checkbox icheck" style="padding-left: 20px;">
                                        <label><input type="checkbox" <?= $isactval ?> name="sop[isact]" class="" value="1" placeholder=""> Is Active</label>
                                    </div>  
                                </div> 
								<div class="form-group"> 
                                    <div class="checkbox icheck" style="padding-left: 20px;">
                                        <label><input type="checkbox" <?= $isdelval ?> name="sop[isdel]" class="" value="1" placeholder=""> Is Deleted</label>
                                    </div>  
                                </div>
                            </div><!-- /.box-body -->
            ...
            <div class="col-md-6">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Sales Operations List</h3> (Click Edit to change details)
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <table class="table table-bordered">
                            <tr>
                                <th style="width: 180px">Sales Operation</th>
                            ...
                            foreach ($Operations as $loc) {
                                ...
                                echo '<tr class="info">
                                        ...
                                        <td><a class="btn btn-primary btn-xs" href="' . base_url('index.php/master/salesOperations/' . $loc['id']) . '">Edit</a></td>
