    ...
    <section class="content">
        <div class="row">
            <div class="col-md-6">
				...
				$isdelval = '';
                $btnmsg = 'Create Sales Zone Mapping';
                ...
                <form id="frmLocation" role="form" action="<?= base_url('index.php/master/saveZoneMapping') ?>" method="post">
                    <fieldset>
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">Zone Mapping</h3> (Enter Zone Mapping Details)  <a class="btn btn-success pull-right btn-sm" href="<?= base_url('index.php/master/createZoneMapping/') ?>"><i class="fa fa-plus"></i> New</a>                              
                            </div><!-- /.box-header -->
                            <div class="box-body">
								
                                <div class="form-group">
                                    <select class="form-control" name="sop[parent]">
										<option value="">--Select Parent Zone--</option>
									<?php
										if(!empty($ZoneDataSet) && isset($ZoneDataSet)){
											foreach($ZoneDataSet as $z){
									?>
                                ...
                                <div class="form-group">
                                    <select class="form-control"  name="sop[child]">
										<option value="">--Select Child Zone--</option>
									<?php
										if(!empty($ZoneDataSet) && isset($ZoneDataSet)){
											foreach($ZoneDataSet as $z){
									?>
            ...
            <div class="col-md-6">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Sales Zone Mapping List</h3> (Click Edit to change details)
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <table class="table table-bordered" id="example1">
                            <tr>
                                <th style="width: 180px">Child Zone</th>
                                <th style="width: 180px">Is Parent of Zone</th>
                            ...
                            <?php
							if(!empty($ZoneMapDataSet) && isset($ZoneMapDataSet)){
								foreach ($ZoneMapDataSet as $loc) {
									$action = 0;
