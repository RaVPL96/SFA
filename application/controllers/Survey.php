    ...
    function surveySoyamonitor($msg = null, $survey_id = null) {
        ...
        if ($survey_id == null) {
            ...
            // if (!empty($_POST['DateRange']) && isset($_POST['DateRange'])) {
                ...
                $salesRep = '';
                // $catego = $_POST['category'];
                $data['FromDate'] = $FromDate= '2024-12-13';
                $data['ToDate'] = $ToDate= '2024-12-20';
                $data['area_list'] = $this->SurveyModel->getSurveyAreaList($FromDate, $ToDate, $areaID, $territoryID, $rangeID);
                //$data['BillCount']=$this->HrModule->getBillCount(null,$FromDate,$ToDate);     
                //$data['TimeAttendance'] = $this->HrModule->getTimeAttendance(null,$FromDate,$ToDate); 
            ...
            $data['TotalSample'] = $this->SurveyModel->getTotalSoap($survey_id,$catego);
            $data['TotalSampleDetails'] = $this->SurveyModel->getSoapSurveyDetails(null, null, null, null, null, $survey_id,$catego);
            $data['categoryy'] = $catego;
            $data['paraGraphData'] = $this->SurveyModel->getTotalSoapCategory($catego);
            $this->load->view('template/header', $data);
            if($catego==1){
                $this->load->view('secondary/survey/monitor_soap_2024'); // Laundry Soap
            }
            
            // else if($catego==2){
            //     $this->load->view('secondary/survey/monitor_beauty_soap_2024'); // Beauy Soap
            // }
            // else if($catego==3){
            //     $this->load->view('secondary/survey/monitor_baby_soap_2024'); // baby Soap
            // }else if($catego==4){
            //     $this->load->view('secondary/survey/monitor_soap_2024'); // bath Soap
            // }else if($catego==5){
            //     $this->load->view('secondary/survey/monitor_soap_2024'); // Aurvedic Soap
            // }else if($catego==6){
            //     $this->load->view('secondary/survey/monitor_soap_2024'); // Bar Soap
            // }
