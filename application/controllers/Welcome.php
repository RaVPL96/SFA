...
class Welcome extends CI_Controller
{
    ...
    public function index_dashboard($msg = null)
    {
        ...
        if (
            ...
            if (!empty($dateRangePassed) && isset($dateRangePassed)) {
                $dateRangePassed = str_replace(
                    "~",
                    " - ",
                    str_replace("-", "/", trim($dateRangePassed))
                );
            ...
            $data["FromDate"] = $FromDate = str_replace(
                "/",
                "-",
                trim($RangeArr[0])
            );
            $data["ToDate"] = $ToDate = str_replace(
                "/",
                "-",
                trim($RangeArr[1])
            );
            $data["targetData"] = $this->SalesreportModule->getTarget(
                $year,
                $month
            );
            ...
            if (!empty($_POST["areaID"]) && isset($_POST["areaID"])) {
                ...
                if (!empty($_POST["rangeID"]) && isset($_POST["rangeID"])) {
                    ...
                    $data["RangeName"] = $this->MasterModule->getRange(
                        $rangeID
                    );
                }

                //echo $area_id.'/'. $territoryID.'/'. $routeID.'/'. $rangeID.'/'. $billMethod.'/'. $FromDate.'/'. $ToDate.'/'. 'summery_territory';
                $data["SalesData"] = $this->SalesreportModule->getDailyPcTotals(
                    $area_id,
                    $territoryID,
                    $routeID,
                    $rangeID,
                ...
                $data[
                    "SalesDataTerritory"
                ] = $this->SalesreportModule->getDailyPcTotals(
                    $area_id,
                    $territoryID,
                    $routeID,
                    $rangeID,
            ...
            if ($sess["grade_id"] != 5 && $sess["grade_id"] != 4) {
                //not for sales rep and other users also except ASE
                $data[
                    "ChannelMapping"
                ] = $this->SalesreportModule->getChanneltoAreaMap();

                foreach ($data["ChannelMapping"] as $c) {
                    $data["RangeList"] = $this->SalesreportModule->getRangeList(
                        $c["channel_id"]
                    );
                    foreach ($data["RangeList"] as $r) {
                        //echo "SalesData_Area_Summery_".$c['channel_id']."_".$r['range_id'];
                        if ($r["range_id"] == 5) {
                            // skip town operation and consider that as a D value
                        } else {
                            $data[
                                "SalesData_Area_Summery_" .
                                    $c["channel_id"] .
                                    "_" .
                                    $r["range_id"]
                            ] = $this->SalesreportModule->getDailyPcTotals(
    ...
    public function index($msg = null)
    {
        ...
        if (
            ...
            $data["AreaList"] = $this->MasterModule->getArea(
                null,
                $data["channelID"],
                1
            );
            ...
            $data[
                "targetData"
            ] = $this->SalesreportModule->/*getTarget*/ getTargetNewDemarcation(
            ...
            if (!empty($_POST["areaID"]) && isset($_POST["areaID"])) {
                ...
                if ($data["channelID"] == 1) {
                    ...
                    $data[
                        "SalesData"
                    ] = $this->SalesreportModule->getDailyPcTotalsNew(
                        $area_id,
                        $territoryID,
                        $routeID,
                        $rangeID,
    ...
    public function sales($msg = null)
    {
        ...
        if (
            ...
            $data[
                "targetData"
            ] = $this->SalesreportModule->getTargetNewDemarcation(
                date("Y", strtotime($FromDate)),
                date("m", strtotime($FromDate)),
                $areaIDPassed
            );
            ...
            if (!empty($_POST["areaID"]) && isset($_POST["areaID"])) {
                ...
                if ($data["channelID"] == 1) {
                    $data[
                        "SalesData"
                    ] = $this->SalesreportModule->getDailyPcTotalsNewDemarcation(
                        $area_id,
                        $territoryID,
                        $routeID,
                        $rangeID,
                    ...
                    $data[
                        "SalesData"
                    ] = $this->SalesreportModule->getDailyPcTotalsNewNewDemarcation(
                        $area_id,
                        $territoryID,
                        $routeID,
                        $rangeID,
    ...
    function home($msg = null)
    {
        ...
        if (
            ...
            if (
                ...
                $data[
                    "WorkingDates"
                ] = $this->SalesreportModule->getCompanyWorkingDays(
                    $FromDate,
                    $ToDate
                );
                $data[
                ...
                $data[
                    "CategoryList"
                ] = $this->SalesreportModule->getCategoryList(3);
                if ($data["RangeID"] == "D") {
                    if (
                        ...
                        $data[
                            "categoryLineData"
                        ] = $this->SalesreportModule->getCategoryList(
                            3,
                            $data["categoryID"]
                        );
                        $data[
                            "getTotalSalesandPc"
                        ] = $this->SalesreportModule->getTotalSalesandPcCategory(
                            $data["AreaID"],
                            $data["RangeID"],
                        ...
                        ] = $this->SalesreportModule->getTotalSalesandPc(
                            $data["AreaID"],
                            $data["RangeID"],
                            $data["datepickermonth"]
                        );
                        $data[
                            "DailySales"
                        ] = $this->SalesreportModule->getDailySalesCategory(
                            $data["AreaID"],
                            $data["RangeID"],
                            $data["datepickermonth"],
                            $data["categoryID"]
                        ...
                        $data[
                            "targetData"
                        ] = $this->SalesreportModule->getTarget(
                        ...
                        $data[
                            "DailySales"
                        ] = $this->SalesreportModule->getDailySales(
                            $data["AreaID"],
                            $data["RangeID"],
                            $data["datepickermonth"]
                        );
    ...
    function homeReport($msg = null)
    {
        ...
        if (
            ...
            $data["CategoryList"] = $this->SalesreportModule->getCategoryList(
                3
            );
            //$data['DailySales'] = $this->SalesreportModule->getDailySales($data['AreaID'], $data['RangeID']);
            if (
                ...
                if ($data["RangeID"] == "D") {
                    if (
                        ...
                        $data[
                            "getTotalSalesandPc"
                        ] = $this->SalesreportModule->getTotalSalesandPcCategoryNewDemarcation(
                            $data["AreaID"],
                            $data["RangeID"],
                            $data["datepickermonth"],
                            $data["categoryID"],
                        ...
                        $data[
                            "getTotalSalesandPcFull"
                        ] = $this->SalesreportModule->getTotalSalesandPcNewDemarcation(
                            $data["AreaID"],
                            $data["RangeID"],
                            $data["datepickermonth"],
                            $data["saleType"]
                        ...
                        $data[
                            "DailySales"
                        ] = $this->SalesreportModule->getDailySalesCategoryNewDemarcation(
                            $data["AreaID"],
                            $data["RangeID"],
                            $data["datepickermonth"],
                            $data["categoryID"],
                        ...
                        $data[
                            "DailySales"
                        ] = $this->SalesreportModule->getDailySalesNewDemarcation(
                            $data["AreaID"],
                            $data["RangeID"],
                            $data["datepickermonth"],
                            $data["saleType"]
