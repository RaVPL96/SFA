...
class Salesreports extends CI_Controller {
    ...
    function cancellation($msg = null) {
        ...
        if (isset($_POST['DateRange']) && !empty($_POST['DateRange'])) {
            ...
            if(!(isset($_POST['territoryID']) && !empty($_POST['territoryID']))){
              $data['dataInfo'] = $this->SalesreportModule->getCancellation($FromDate, $ToDate, $data['sbTerritory'], 'summery', $data['areaID'], $data['sbRange']);  
            }
            

            //if(!(isset($_POST['territoryID']) && !empty($_POST['territoryID']))){
            $data['detailInfo'] = $this->SalesreportModule->getCancellation($FromDate, $ToDate, $data['sbTerritory'], 'territory_detail', $data['areaID'], $data['sbRange']);
            $data['territoryData'] = $this->SalesreportModule->getCancellation($FromDate, $ToDate, $data['sbTerritory'], 'territory_summery', $data['areaID'], $data['sbRange']);
            //}
        }
