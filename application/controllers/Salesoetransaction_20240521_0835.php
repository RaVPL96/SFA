...
class Salesoetransaction extends CI_Controller {
    ...
    function SaveOrderentry($id = null, $msg = null){
        ...
        $this->ItemsModel->saveStockDetail($rowCount,$sellable,$damageQty,$unitPrice,$subTotal,$netTotal,$payments,$balance,$upRowCount,$up_itemCode,$up_itemName,$up_sellable,$up_damageQty,$up_unitPrice,$up_subTotal,$rangeId,$areaID,$territoryID,$requestDate);
