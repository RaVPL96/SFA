...
class Salesreports extends CI_Controller {
    ...
    function nonMovingReport($msg = null) {
        ...
        if (!empty($_POST['DateRange']) && isset($_POST['DateRange'])) {
           ...
           // $this->HrModule->setAttendance($FromDate, $ToDate);
            //$data['AttenType']=$this->SalesreportModule->getNonMovingItems();
            ...
            $data['NonMovingItems'] = $this->SalesreportModule->getNonMovingItems($item, $des, $Actual_Qty, $Actual_Val, $FromDate, $ToDate);                  
        }
        $this->load->view('template/header', $data);
    ...
    /*function nonMovingReport($msg = null) {
        ...
        if (!empty($_POST['categoryID']) && isset($_POST['categoryID'])) {
            ...
            $data['SalesData'] = $this->SalesreportModule->getNonMovingItems($item, $des, $Actual_Qty, $Actual_val, $FromDate, $ToDate);
        }
