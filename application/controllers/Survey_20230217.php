...
class Survey extends CI_Controller {
    ...
    function surveymonitor($msg = null){
        ...
        if (!empty($_POST['DateRange']) && isset($_POST['DateRange'])) {
            ...
            $data['TimeAttendance'] = $this->SurveyModel->getSurveySummery($FromDate, $ToDate,$areaID,$territoryID,$rangeID,6);
        }
        $data['TotalSample']= $this->SurveyModel->getTotal(6);
        $data['TotalSampleDetails']= $this->SurveyModel->getSurveyDetails(null, null,  null,  null, null,6);
